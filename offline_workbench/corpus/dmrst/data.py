"""Offline DMRST corpus document conversion."""
...
class Document:
    def __init__(self, dpath: str | Path) -> None:  # ? parse=parse, raw=raw
        ...
        self.edudict: Any = None  # EDU dict: id EDU -> list of id tokens or text
        self.outbasename = self.path.name  # Name of the output file, can be modified for the RST DT
