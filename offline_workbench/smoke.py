...
COMMANDS = (
    ...
    CommandCategory(name="dmrst-parser-training", category="parser-training", argv=("-m", "offline_workbench.training.parsers.dmrst_runs", "--help"), timeout_seconds=20),
    CommandCategory(name="unirst-parser-training", category="parser-training", argv=("-m", "offline_workbench.training.parsers.unirst_runs", "--help"), timeout_seconds=20),
    ...
    CommandCategory(name="rst-evaluation", category="evaluation", argv=("-m", "pytest", "tests/test_parseval_math.py", "-q"), timeout_seconds=60),
    CommandCategory(name="erst-research", category="research", argv=("-m", "pytest", "tests/research_harness/test_runner.py", "-q"), timeout_seconds=60),
