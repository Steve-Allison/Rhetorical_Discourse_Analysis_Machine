...
Do not break this boundary: production code (`rst/isanlp_rst/`, `machine/rdam/`, `rst/rdam_rst/`) must never import offline/dev packages (`pytest`, `nltk`, `peft`, `fire`, `jsonnet`, `blake3`).
