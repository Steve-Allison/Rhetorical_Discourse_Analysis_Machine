"""
Offline UniRST relation sets and corpus mappings.
"""

type RelationMapping = dict[str, str]
...
rstdt_mapping18: RelationMapping = {
    "analogy": "Comparison",
    "antithesis": "Contrast",
    "attribution": "Attribution",
    "attribution-negative": "Attribution",
...
brazilianCst_labels: RelationMapping = {  # The most similar to the RST
...
brazilianSum_labels: RelationMapping = {
    "antithesis": "antithesis",
    "attribution": "attribution",
    "background": "background",
    "circumstance": "circumstance",
...
brazilianTCC_labels: RelationMapping = {
    "antithesis": "antithesis",
    "attribution": "attribution",
    "background": "background",
    "circumstance": "circumstance",
...
germanPcc_labels: RelationMapping = {
    "antithesis": "antithesis",
    "background": "background",
    "cause": "cause",
    "circumstance": "circumstance",
...
spanish_labels: RelationMapping = {
