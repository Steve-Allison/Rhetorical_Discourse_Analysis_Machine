...
class TechnologySystem(BaseModel):
    ...
    role: SystemRole
    implementation_module: str = Field(pattern=r"^workbench.research\.erst\.systems\.[a-z0-9_]+$")
...
def build_technology_matrix(tokenizer_receipt_path: Path) -> TechnologyMatrix:
    ...
    systems = (
        _model_system(
            ...
            module="workbench.research.erst.systems.dual_encoder",
        ...
        TechnologySystem(
            ...
            implementation_module="workbench.research.erst.systems.structural",
            model_license="MIT",
        ...
        _model_system(
            ...
            role=SystemRole.CONTROL,
            module="workbench.research.erst.systems.cross_encoder",
        ...
        TechnologySystem(
            ...
            role=SystemRole.CONTROL,
            implementation_module="workbench.research.erst.systems.signal_rule",
            model_license="MIT",
        ...
        _model_system(
            ...
            role=SystemRole.CANDIDATE,
            module="workbench.research.erst.systems.hierarchical_adapter",
        ...
        _model_system(
            ...
            role=SystemRole.CANDIDATE,
            module="workbench.research.erst.systems.generative_decoder",
        ...
        TechnologySystem(
            ...
            implementation_module="workbench.research.erst.systems.graph_attention",
