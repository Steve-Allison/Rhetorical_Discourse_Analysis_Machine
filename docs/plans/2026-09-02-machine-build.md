...
- SDRT / Toulmin / Walton / PDTB: `unavailable(not_implemented)` — no stubs.
...
| 008 | ~~Workbench promotion system~~ | **removed 2026-09-02** by owner ruling — never requested, and it reported working parsers as `unavailable`. `specs/008-promotion-system/` deleted. |
...
| 011 | Dung provider (formal) | **done** — `specs/011-dung-provider/`; relocated to `rdam.dung` in the single-package restructure |
| 012 | IBIS provider (formal) | **done** — `specs/012-ibis-provider/`; built at `rdam.ibis` |
