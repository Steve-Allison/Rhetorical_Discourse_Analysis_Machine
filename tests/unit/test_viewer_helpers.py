"""Unit tests for viewer convenience helpers in ``rdam.rst``."""

from pathlib import Path
from unittest.mock import patch

from rdam.rst import to_html
...
def test_to_html_returns_string_and_writes_file(tmp_path: Path) -> None:
    ...
    with patch("rdam.rst._rst_main.rs3tohtml", return_value="<html/>") as mock_rs3:
