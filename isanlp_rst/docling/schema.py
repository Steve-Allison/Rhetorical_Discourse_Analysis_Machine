"""Self-contained Docling-native RST wire schema."""
...
class HarvestSpan:
    """One harvested Docling span with offsets into its parser input."""
...
@dataclass(frozen=True, slots=True)
class Boundary:
    """One independently detected structural boundary."""
...
class DoclingRstResult:
    ...
    def to_format_analysis(self) -> FormatRstAnalysis:
        ...
        return projection_to_format_analysis(
            ...
            refs_of_edu=attrgetter("self_refs"),
            producer=self.tool,
