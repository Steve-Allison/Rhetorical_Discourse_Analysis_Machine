...
## Corpus Check
- 945 files · ~934,044 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27727 nodes · 44514 edges · 1896 communities (1171 shown, 705 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2267 edges (avg confidence: 0.94)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a1c02b0d`
...
- Academic and Visionary Bundles
- Rhetorical Devices
- Presentation Openers
- Boost and Hedge Markers
- Figurative Language
...
- PDTB Provider Tests
- SDRT Provider Tests
- Toulmin Technique Tests
- Walton Technique Tests
- Repository Tooling
- Ingest Promotion Tooling
- Corpus Preparation
- Model Evaluation
...
- Pedagogical Frameworks Taxonomy
- Realisation Forms Taxonomy
- Scoring Taxonomy
- Terminology Term Referents
- Analytical Frameworks Taxonomy
- Action Title Formatting
- Audience Centric Storytelling
- Code Glossing Techniques
- Comparison Markers
- Compliance Markers
- Data Storytelling Arcs
- Deictic Markers
- Emotional Story Arcs
- Curiosity Emotional Arcs
- Skeptic Emotional Arcs
- Emphasis Markers
...
- Multiplier Metrics
- Narrative DNA
- Pyramid Apex Structure
- Quote Hooks
- Reformulation Markers
- Academic SME Persona
- Absent SME Persona
- Busy Bee SME Persona
- Clueless SME Persona
- Dominant SME Persona
- Overinclusive SME Persona
- Luddite SME Persona
- Social Proof Techniques
- Sparkline Narratives
- Novice Speaker Persona
- Performer Speaker Persona
- Technocrat Speaker Persona
- Visionary Speaker Persona
- Star Moment Techniques
- Summary Markers
- Surprisal Oscillation
- Document Page Layout
- Hero Banner Layout
- Interactive Scenario Layout
- Knowledge Organiser Layout
- Lottie Animation Layout
- Presentation Slide Layout
- Quiz Layout Specifications
- Retrieval Grid Layout
- SVG Canvas Layout
- Chartjunk and Visual Noise
- Color Scheme Types
- Duarte Slidedoc Format
- Visual Focal Points
- Functional Slide Design
- Gestalt Visualization Principles
- Preattentive Visual Attributes
- Product Slide Design
...
- Delivery Domain Manifest
- Language Editorial Manifest
...
- RAG Strategies
- Slide QA Pipelines
- Visualization Generation Pipelines
- Buyer Audiences
- Sales Champions
- Competitive Claims
- Competitor Mentions
...
- Technical Buyers
- User Buyers
- Elevator Pitch Rubrics
- Sales Cadence
- Acoustic Leadership
- Audio Jitter Metrics
- Presentation Scenography
- Gesture Taxonomy
- Modality Conflict Markers
- Personal Branding
- Presentation Rehearsals
- Audio Shimmer Metrics
- Stereotype Content Model
- Speech Uptalk Indicators
- Speech Cadence
- Presentation Hooks
- Speech Pacing
- Vocal Tone
...
- Dual Coding Theory
- Embodied Cognition
- Multimedia Embodiment Principle
- Faceted Classification
- Formative Assessment
- Generative Learning Principles
- Multimedia Image Principle
- Immersive Learning Principles
- Information Ecology
- Multimedia Modality Principle
- Classification Rules
- Performance Support
- Multimedia Personalization Principle
- Hierarchical Classification
- Multimedia Pre-Training Principle
- Text Readability Metrics
- Multimedia Redundancy Principle
- Memory Retrieval Strength
- Multimedia Segmenting Principle
- Multimedia Signalling Principle
- Presentation Design Pitfalls
...
- Character Archetypes
- Epistemic Certainty
- Trend Analysis Decreases
- Trend Analysis Increases
- Discourse Analysis
- Attribution Analysis
- Rhetorical Boosting
- Rhetorical Discounting
- Rhetorical Hedging
- Discourse Markers
- Rhetorical Boosting
- Rhetorical Hedging
...
- Toulmin Validation Quickstart
- Walton Provider Evidence
- Walton Validation Quickstart
- SDRT Provider Evidence
- SDRT Provider Quickstart
...
- properties
- properties
- machine-configuration.serialization.schema.json
- machine-configuration.validation.schema.json
- enum
- enum
- machine-native-result.serialization.schema.json
- machine-native-result-v1.serialization.schema.json
- machine-native-result-v1.validation.schema.json
- machine-native-result.validation.schema.json
- required
- edus
- required
- edus
...
- AnnotationRepresentation
- AnnotationRepresentation
- machine-walton-result.serialization.schema.json
- properties
- properties
- properties
- machine-walton-result.validation.schema.json
- properties
- contributing_item_ids
- machine-capabilities.serialization.schema.json
- enum
- enum
- enum
- machine-capabilities.validation.schema.json
- enum
- properties
- properties
- required
...
- enum
- enum
- machine-ibis-result.serialization.schema.json
- $defs
- machine-ibis-result.validation.schema.json
- $defs
- contributing_item_ids
- contributing_item_ids
- enum
...
- ComplexDiscourseUnit
- ElementaryDiscourseUnit
- machine-walton-result-v1.serialization.schema.json
- required
- machine-walton-result-v1.validation.schema.json
- required
- enum
- enum
- enum
...
- max_workers
- max_workers
- machine-dung-result.serialization.schema.json
- machine-dung-result.validation.schema.json
- properties
- properties
- nodes
- properties
...
- code
- machine-pdtb-result.serialization.schema.json
- enum
- machine-pdtb-result.validation.schema.json
- enum
...
- properties
- properties
- machine-toulmin-result.serialization.schema.json
- machine-toulmin-result-v1.serialization.schema.json
- required
- machine-toulmin-result-v1.validation.schema.json
- required
...
- properties
- machine-capabilities-v1.validation.schema.json
- properties
- ExtensionOutput
- enum
- ExtensionOutput
...
- ExtractionRecord
- SourceEvidenceSpan
- machine-version.serialization.schema.json
- properties
...
- InputIssue
- InputIssue
- machine-preparation-request.serialization.schema.json
...
- **Architecture Decisions & Modernization** — artifacts_reviews_architecture_decisions_erst_runtime_workbench_boundary, artifacts_reviews_architecture_decisions_parser_infrastructure_consolidation, artifacts_reviews_architecture_decisions_viewer_in_memory_layout, artifacts_reviews_python_3_14_performance_evidence_2026_09_03 [EXTRACTED 0.95]
- **Production Codeline Split Contracts** — specs_003_production_codeline_split_contracts_environment_and_artifact, specs_003_production_codeline_split_contracts_model_promotion, specs_003_production_codeline_split_contracts_ownership_and_boundary [EXTRACTED 0.95]
- **Production Ingest Contracts and Evidence** — specs_002_production_source_ingest_contracts_preparation_and_provenance, specs_002_production_source_ingest_contracts_promotion_evidence, specs_002_production_source_ingest_evidence_current_practice_comparison [EXTRACTED 0.95]
- **Rhetorical Discourse Analysis Machine (RDAM) Composition** — specs_007_aggregate_contract_research, specs_009_rst_provider_adapter_research, specs_011_dung_provider_research [EXTRACTED 0.95]
...
- **Feature 004: Production API Contract** — specs_004_production_api_contract_spec, specs_004_production_api_contract_plan, specs_004_production_api_contract_data_model, specs_004_production_api_contract_quickstart, specs_004_production_api_contract_research, specs_004_production_api_contract_tasks, specs_004_production_api_contract_contracts_analysis_evidence, specs_004_production_api_contract_contracts_distribution_and_public_surface [EXTRACTED 1.00]
...
## Communities (1896 total, 705 thin omitted)

### Community 0 - "ProductionIngestor"
Cohesion: 0.03
Nodes (147): _cache_error(), ProductionIngestCache, Exception, Retryability, Local cache keyed by the complete semantic analysis-request identity., DiagnosticPolicy, FailureCategory, LifecycleStage (+139 more)

### Community 1 - "service.py"
Cohesion: 0.08
Nodes (40): AnalysisRequest, CacheStatus, Disposition, AnalysisRequest, AnalysisSemanticEvidence, CacheStatus, PreparationOutcome, ContentInventoryItem (+32 more)

### Community 2 - "contracts/erst.py"
Cohesion: 0.03
Nodes (118): EvidenceDetailPolicy, CandidateDocumentSelection, _canonical_model_hash(), ErstCalibrationState, ErstCheckpointBuildSpec, ErstCheckpointComponent, ErstCheckpointFile, ErstCheckpointFileRole (+110 more)

### Community 3 - "test_shared_runtime_internals.py"
Cohesion: 0.04
Nodes (70): json_projection(), Any, Path, One canonical JSON and SHA-256 kernel for every RDAM runtime contract., Project supported Python values onto the JSON data model without loss., Reject values outside the interoperable JSON subset used by contracts., Stream a local regular file into a SHA-256 digest., sha256_file() (+62 more)
...
Cohesion: 0.04
Nodes (137): BoundaryPreference, ItemAnchor, ItemRelationship, LegacyInventoryItem, LegacySourceArtifact, LineEndingParameters, CoverageUnit, ExactCoverage (+129 more)

### Community 6 - "CorpusPartition"
Cohesion: 0.04
Nodes (106): CorpusPartition, Official GUM document partitions., _protocol(), Contract tests for executable eRST comparison evidence., _resource_evidence(), _successful_run(), test_champion_manifest_rejects_test_access(), test_failed_run_retains_typed_evidence_without_blocking_other_systems() (+98 more)

### Community 7 - "ToulminProvider"
Cohesion: 0.05
Nodes (51): Toulmin layout analysis over raw text, backed by a language model., ToulminProvider, NativeTechniqueResult, Retryability, Walton scheme analysis over raw text, backed by a language model., WaltonProvider, _analyse(), _assert_explicit_licence() (+43 more)

### Community 8 - "erst/data.py"
Cohesion: 0.05
Nodes (59): _candidate(), Focused system serialization and private candidate-cache contract tests., test_candidate_cache_round_trips_gold_fields_and_overlapping_signal_spans(), test_signal_aware_serialization_preserves_each_exact_overlapping_anchor(), test_text_only_serialization_contains_no_signal_or_structure_tokens(), AblationName, Every mandatory removal study in frozen protocol order., _ablate_candidate() (+51 more)

### Community 9 - "final_data.py"
Cohesion: 0.21
Nodes (13): ExperimentDocumentIdentity, Text-free identity and candidate count for one governed document., _build_final_cache(), FinalEvaluationCacheManifest, _load_candidate_file(), prepare_final_evaluation_corpus(), BaseModel, model_validator (+5 more)

### Community 10 - "test_native_integrity.py"
Cohesion: 0.17
Nodes (28): One complete Toulmin layout: the core triad, plus whatever qualifies it. This…, ToulminLayout, _instance(), _layout(), JsonValue, parametrize, SchemeId, Feature 019 regressions for native assessment and source-evidence contracts.… (+20 more)

### Community 11 - "cli.py"
Cohesion: 0.04
Nodes (119): ArgumentParser, Category, ContractSupport, LogRecord, Namespace, NoReturn, canonical_json_bytes(), Return RFC 8785 bytes for the canonical JSON projection of ``value``. (+111 more)

### Community 12 - "SecondaryEdgeCandidate"
Cohesion: 0.04
Nodes (76): DiGraph, DecodeRejectionReason, ErstDecodeReceipt, Reconciled proof of threshold selection and formal eRST constraints., The only formal reasons an above-threshold eRST edge may be rejected., Any, eRST graph completer: secondary-edge candidate generation and signal anchoring., Project the evidence-complete completion trace to its final graph. (+68 more)

### Community 13 - "OntologyAdapter"
Cohesion: 0.05
Nodes (45): Rhetorical relation annotation or model scheme., RelationSchemeEnum, Runtime projection of raw GUM eRST relations to ontology concepts., Project one raw GUM relation while preserving the caller's raw value., resolve_gum_relation_concept(), OntologyAdapter, Checked ontology adapters for model encodings and corpus label mappings., Resolve a predicted model class integer index into canonical label, concept,… (+37 more)

### Community 14 - "PdtbProvider"
Cohesion: 0.11
Nodes (23): PdtbProvider, NativeTechniqueResult, Retryability, Sha256Identity, Produce validated native PDTB-3 relations from raw text., source_identity(), never_a_real_request(), no_credentials() (+15 more)

### Community 15 - "corpus.py"
Cohesion: 0.04
Nodes (110): CandidateSelectionReceipt, CorpusAuthorityEntry, CorpusDocumentReceipt, CorpusFailureType, CorpusLicenseClass, CorpusLoadFailure, CorpusLoadReceipt, GumCorpusAuthority (+102 more)

### Community 16 - "Machine"
Cohesion: 0.05
Nodes (92): BoundaryConfiguration, HTTPResponse, create_app(), Machine, AggregateAnalysis, One explicit outcome per requested technique; successes are preserved…, Runs several techniques side by side without collapsing them into one formalism., RFC 8785 canonical bytes of a digest-verified record. (+84 more)

### Community 17 - "thaw_json"
Cohesion: 0.09
Nodes (22): Never, field_serializer, field_validator, JsonValue, field_serializer, field_validator, JsonValue, freeze_json() (+14 more)

### Community 18 - "parser_result.py"
Cohesion: 0.05
Nodes (116): AnchorTargetKind, ErstCandidateDecision, AnalysedDocument, AnalysisAnchor, AnalysisPolicy, ParserAnalysisResult, ParserAnalysisSemanticEvidence, CompositeAnalysisIdentity (+108 more)

### Community 19 - "Parser"
Cohesion: 0.04
Nodes (58): Parser, AnalysisPolicy, Any, CompositeAnalysisIdentity, device, dtype, Path, Resolve canonical parser family from runtime contract string. (+50 more)

### Community 20 - "StructuredAnalyst"
Cohesion: 0.03
Nodes (75): Agent, AgentRunResult, Model, NonNegativeInt, configured_model(), Extraction, load_dotenv(), _model_without_implicit_retries() (+67 more)
...
Cohesion: 0.05
Nodes (78): PrivateCorpusVerificationReceipt, Full-source and sampled-candidate verification for the private corpus., AblationAdapter, AblationDefinition, AblationPlan, AblationResult, canonical_ablation_plan(), BaseModel (+70 more)
...
Cohesion: 0.07
Nodes (48): ElementaryDiscourseUnit, _ClosedModel, ComplexDiscourseUnit, _connected(), _elementary_members(), ElementaryDiscourseUnit, GraphError, _has_cycle() (+40 more)

### Community 27 - "test_parseval_math.py"
Cohesion: 0.04
Nodes (67): Counter, DirectedSpanKey, K, find_cdu(), _is_leaf(), Any, Analytical helpers for parsed RST trees. These functions operate on…, Classify an RST relation label as subject-matter or presentational. Follows… (+59 more)

### Community 28 - "technology.py"
Cohesion: 0.09
Nodes (38): HfApi, Hashed Python/Transformers/MPS compatibility receipt for mandatory tokenizers., TokenizerCompatibilityReceipt, Technology-matrix tests for completeness, evidence, and non-substitution., _required_revision(), test_frozen_live_matrix_has_weight_evidence_for_every_model_row(), test_hub_evidence_must_cover_every_model_and_preserve_revision_and_license(), test_matrix_rejects_dropped_system() (+30 more)

### Community 29 - "rdam/ingest/__init__.py"
Cohesion: 0.05
Nodes (103): LegacyAnchor, AnalysedEdu, AnalysisExecutionEvidence, AnalysisStatus, AnalysisSubstrateTransformation, AnchorTargetKind, CheckClassification, CheckOutcome (+95 more)
...
### Community 33 - ".for_text"
Cohesion: 0.05
Nodes (54): NativeTechniqueResult, One technique's unchanged native payload, with analytical and artifact…, ExecutionPolicy, Bounded execution settings for one local machine composition., Produce a validated native SDRS graph from raw text., SdrtProvider, source_identity(), Retryability (+46 more)

### Community 34 - "grammar.py"
Cohesion: 0.06
Nodes (38): DeliberationMap, deliberation_map(), IbisInputLink, IbisInputNode, IbisStructure, _ids(), _is_link(), _is_node() (+30 more)

### Community 35 - "properties"
Cohesion: 0.04
Nodes (59): items, minItems, title, type, properties, items, minItems, title (+51 more)

### Community 36 - "properties"
Cohesion: 0.04
Nodes (56): anyOf, default, additionalProperties, properties, title, type, additionalProperties, properties (+48 more)
...
Cohesion: 0.06
Nodes (48): Dataset, inference_mode, InvalidSegmenterCheckpointError, Any, PreTrainedModel, ValueError, Segment raw text into a sequence of typed Edu records., Raised when a path is not a complete, trained EDU-segmentation checkpoint. (+40 more)
...
Cohesion: 0.04
Nodes (50): items, minItems, title, type, properties, items, minItems, title (+42 more)
...
### Community 51 - "ingest/public_surface.py"
Cohesion: 0.06
...
### Community 53 - "production_ingest/conftest.py"
Cohesion: 0.04
Nodes (63): CacheDirectoryBuilder, ModelIdentityBuilder, PrivateMarkerBuilder, EmptyExecution, model_validator, Self, Shared invariants and identities for production contract 2.0.0., Normalized public-contract version with no prerelease or local suffix. (+55 more)
...
### Community 60 - "Technique"
Cohesion: 0.03
Nodes (195): AnalysisReadingGuide, LookupError, PersistedRecord, AvailableCapability, FailedOutcome, FormalismChoice, FormalismDeclaration, ProviderDependencyReference (+187 more)
...
Cohesion: 0.03
Nodes (57): ProductionIngestor, ProviderRequest, What the machine hands one provider: the shared source and that provider's…, input_origin(), NativeTechniqueResult, ``supplied`` by the caller as-is, or ``explicitly_derived`` from a named…, _cache_key(), Provider (+49 more)
...
Cohesion: 0.03
Nodes (106): DmrstParsingNet, DiscourseUnit, Exporter, ForestExporter, Group, Path, Native Rhetorical Structure Theory (RST) tree annotations and RS3…, Populate text across an arbitrarily deep tree from character spans. (+98 more)
...
Cohesion: 0.04
Nodes (49): anyOf, default, title, anyOf, default, title, anyOf, default (+41 more)
...
### Community 79 - "DMRST Data Reader"
Cohesion: 0.09
...
### Community 82 - "production_machine"
Cohesion: 0.05
Nodes (48): Lock, _LlmArguments, production_machine(), TypedDict, Assemble the supported providers without coupling orchestration to techniques., Construct the supported seven-technique production composition. Provider…, ExecutionSettings, LlmSettings (+40 more)
...
Cohesion: 0.08
Nodes (40): describe_capabilities(), ParserDescriptor, Protocol, Model-free and parser-aware production capability discovery., Return installed capabilities without importing a model or optional adapter., Availability, CacheEligibility, CacheEligibilityState (+32 more)
...
Cohesion: 0.20
Nodes (17): _candidate(), parametrize, Promotion authority rejects mutable, contradictory, or waiver-bearing evidence., _source_result(), test_candidate_identity_rejects_changed_or_partial_digests(), test_promotion_decision_cannot_contradict_a_failed_gate_or_inspection(), CandidateIdentity, _EvidenceModel (+9 more)
...
### Community 97 - "ProviderDeclaration"
Cohesion: 0.05
Nodes (70): AvailableCapability, CapabilityState, model_validator, Self, ProviderConfiguration, ProviderDeclaration, A provider's identity, formalisms, contract version, and standing state., describe() (+62 more)
...
Cohesion: 0.12
Nodes (49): CompletedProcess, test_cli_malformed_input_is_a_canonical_safe_failure(), diagnostic(), json_array(), json_object(), parametrize, Path, The installed grammar and standard streams are the public interface. (+41 more)
...
### Community 110 - "$defs"
Cohesion: 0.05
Nodes (47): additionalProperties, required, title, type, $defs, ArchiveMemberAnchor, FormalismChoice, ItemAnchor (+39 more)

### Community 111 - "properties"
Cohesion: 0.05
Nodes (48): $ref, anyOf, default, const, default, title, type, const (+40 more)

### Community 112 - "resolve_device"
Cohesion: 0.10
Nodes (29): _device_from_spec(), DeviceProbe, device, One authority for PyTorch import ordering, devices, and inference dtypes., Immutable accelerator-availability snapshot, injectable in tests., Resolve the canonical device API and its deprecated integer shim., resolve_device(), ``True`` is a subclass of ``int`` — must still be rejected. (+21 more)
...
Cohesion: 0.05
Nodes (46): items, minItems, title, type, items, minItems, title, type (+38 more)
...
Cohesion: 0.10
Nodes (13): _extras(), ParserInput, Any, Path, Minimal legacy parser-input leaf record required for safe model inventory…, Mutable historical parser record with no corpus or training behavior., Return the parser's exact limiting-unit count for this materialized input., Data (+5 more)

### Community 139 - "erst/runner.py"
Cohesion: 0.07
Nodes (32): PayloadT, test_disabled_mps_sampler_has_no_measurement_side_effect(), _data(), _protocol(), Path, Execution-path tests for the isolated eRST technology-comparison harness., Synthetic system proving the shared runner without private corpus access., _request() (+24 more)
...
Cohesion: 0.07
Nodes (61): ContentInventory, ContentInventory, ContentRequirement, A provider-owned, content-addressed declaration of analysable source., The complete shared inventory, independent of provider projection and execution., UnmetRequirement, SourceForm, TableRepresentation (+53 more)
...
Cohesion: 0.05
Nodes (47): quality, GumCorpusValidationReport, GumGoldValidator, GumValidationReport, Parser, Path, Macro-averaged validation metrics across a corpus of GUM documents., Validator that verifies model predictions or processed files against GUM gold… (+39 more)
...
### Community 153 - "kind"
Cohesion: 0.08
Nodes (28): properties, title, type, PageAnchor, title, type, properties, const (+20 more)
...
Cohesion: 0.07
Nodes (32): PredictorDMRST, Any, Data, device, dtype, Path, Takes data with word level tokenization, run current transformer tokenizer and…, Splits a batch into multiple smaller with given size. (+24 more)
...
Cohesion: 0.04
Nodes (95): Run inference and wrap exact substrate and parse evidence in…, FormatRstAnalysis, Composite analysis for structured documents (Docling, DocLang, Markdown)., A directed secondary rhetorical relation edge without nuclearity., SecondaryRelationEdge, DocumentToken, Edu, ProvenanceRecord (+87 more)

### Community 166 - "neural_scorer.py"
Cohesion: 0.10
Nodes (17): AttentionPooling, BoundaryAwareSpanEncoder, device, dtype, PretrainedConfig, PreTrainedTokenizerBase, Tensor, Neural Secondary Edge Scorer with boundary-aware span pooling and asymmetric… (+9 more)
...
### Community 174 - "TestResolveFamily"
Cohesion: 0.12
...
Cohesion: 0.20
Nodes (23): AnalysedEdu, AnalysedToken, PreparedSegment, AnalysedToken, PreparedSegment, _anchors_for_range(), _enrich_analysis_anchor(), _enrich_edu() (+15 more)
...
### Community 178 - "Sha256Identity"
Cohesion: 0.07
Nodes (23): CompletedStageEvidence, Return the SHA-256 digest of a value's canonical JSON bytes., semantic_sha256(), model_validator, Self, T, _set_outcome_identity(), Unambiguous SHA-256 identity used by every semantic digest field. (+15 more)
...
Cohesion: 0.13
Nodes (15): properties, anyOf, exclusiveMinimum, title, type, $ref, capacity, policy (+7 more)
...
### Community 199 - "GoldSetManifest"
Cohesion: 0.10
Nodes (21): MonkeyPatch, parametrize, Isolated wheel runner fails closed before executing ambiguous candidates., test_baseline_runner_requires_full_immutable_commit(), test_candidate_runner_rejects_invalid_determinism_run_counts(), test_candidate_runner_rejects_nonexistent_wheel(), test_candidate_runner_requires_model_store_and_release_as_one_identity(), _source() (+13 more)
...
### Community 205 - "MetadataRepresentation"
Cohesion: 0.20
...
Cohesion: 0.07
Nodes (29): items, title, type, SourceFormCapability, type, accepted_media_types, missing_distributions, preparation_supported (+21 more)
...
### Community 216 - "baseline_corrections.py"
Cohesion: 0.19
...
Cohesion: 0.11
Nodes (18): OperationCapability, title, type, operation, title, type, additionalProperties, properties (+10 more)

### Community 222 - "required"
Cohesion: 0.11
Nodes (18): source_forms, required, active_parser_family, cache_eligibility, canonical_parser_result_supported, canonical_serialization, evidence_capabilities, evidence_detail_levels (+10 more)

### Community 223 - "required"
Cohesion: 0.09
Nodes (23): required, required, required, analysed_document, analysis, anchors, cache_request_identity, composite_identity (+15 more)

### Community 224 - "ExactCoverage"
Cohesion: 0.05
...
### Community 228 - "$defs"
Cohesion: 0.05
Nodes (44): title, type, enum, title, type, title, type, additionalProperties (+36 more)
...
Cohesion: 0.12
Nodes (17): ListRepresentation, title, items, ordered, additionalProperties, properties, required, title (+9 more)

### Community 232 - "text"
Cohesion: 0.11
Nodes (18): additionalProperties, properties, required, AnnotationRepresentation, label, const, default, title (+10 more)
...
### Community 235 - "test_codecs.py"
Cohesion: 0.18
Nodes (21): _fields(), JsonValue, parametrize, Persisted records reject damaged identities and ambiguous JSON before use., _saved(), test_binary_request_round_trip_uses_standard_padded_base64(), test_changed_native_payload_cannot_keep_saved_identity(), test_duplicate_json_keys_are_rejected_even_when_values_agree() (+13 more)

### Community 236 - "diff_records"
Cohesion: 0.20
...
Cohesion: 0.14
Nodes (14): architecture, compatibility_range, created_at, files, model_task, producer_version, runtime_contract, source_model_identity (+6 more)

### Community 238 - "Research and Decisions: Unified Machine Interfaces"
Cohesion: 0.11
Nodes (18): Clarification coverage, Currency and remaining implementation checks, D10 — Prove equivalent requests, not erased differences, D11 — AI-ready by default, without a second analytical formalism, D12 — Fix native integrity rather than preserve known weaknesses, D13 — Tests and cold critique, without evaluation machinery, D1 — One machine, not a new service layer, D2 — Configuration outside analysis requests (+10 more)

### Community 239 - "mapping"
Cohesion: 0.14
Nodes (14): discriminator, oneOf, ContentRepresentation, mapping, propertyName, annotation, cross_reference, list (+6 more)

### Community 240 - "Parser Attention Tests"
Cohesion: 0.16
...
### Community 244 - "Tasks: Unified Machine Interfaces"
Cohesion: 0.17
Nodes (12): Dependencies and execution order, Implementation strategy, Parallel examples by story, Phase 1: Setup and evidence baseline, Phase 2: Shared contracts — blocks story implementation, Phase 3: US5 — Correct native analysis and make it AI-ready (P1), Phase 4: US1 — One primary Python machine (P1), Phase 5: US3 — Explicit structures and lineage (P1) (+4 more)

### Community 245 - "ExactCoverage"
Cohesion: 0.05
Nodes (45): additionalProperties, properties, required, title, type, minimum, title, type (+37 more)
...
### Community 248 - "ParsingNetBottomUp"
Cohesion: 0.23
...
### Community 259 - "Production API Contract Specification"
Cohesion: 0.07
Nodes (30): Specification Quality Checklist: isanlp-rst 4.0.0 Forensic Remediation, eRST Completion Bundle Contract, Corpus and Experiment Contract, Format Projection Contract, 001 Forensic Remediation Implementation Plan, Verification Quickstart, Research and Authority Ledger, 001 Forensic Remediation Specification (+22 more)
...
### Community 267 - "Adversarial Discriminator Model"
Cohesion: 0.20
...
Cohesion: 0.15
Nodes (24): _artifacts(), _capacity_rename_paths(), capture(), classify(), compare(), Difference, _digest(), _flatten() (+16 more)

### Community 269 - "test_client_lifecycle.py"
Cohesion: 0.20
...
### Community 277 - "UniRST Experiment Runner"
Cohesion: 0.25
...
### Community 280 - "Implementation notes — 2026-09-04"
Cohesion: 0.17
Nodes (12): Final checks and source-first review handoff, Final regression and installed-candidate results, Final semantic repair and verification, Implementation and ordinary regression verification, Implementation notes — 2026-09-04, Initial pause: T004 owner review and independent references, Owner correction applied: ordinary tests and cold critique, Remaining real-artifact prerequisite (+4 more)
...
### Community 284 - "Cleanup Script Tests"
Cohesion: 0.29
...
### Community 285 - "Offline Command Smoke Tests"
Cohesion: 0.29
...
### Community 286 - "CapabilityExecution"
Cohesion: 0.18
...
Cohesion: 0.22
Nodes (9): Chain Of Thought, Decomposition, Few Shot, Prompt Pattern, ReAct, Role Prompting, Self Consistency, Tree Of Thought (+1 more)

### Community 289 - "RAG Pipeline Stages"
Cohesion: 0.22
Nodes (9): Chunking, Embedding, Evaluation, Generation, Indexing, Ingestion, Pipeline Stage, Reranking (+1 more)

### Community 290 - "User Scenarios & Testing *(mandatory)*"
Cohesion: 0.12
...
Cohesion: 0.06
Nodes (45): anyOf, default, const, default, title, type, const, default (+37 more)
...
### Community 295 - "Contract: Analytical Quality Testing"
Cohesion: 0.40
...
### Community 300 - "GenerativeDecoderAdapter"
Cohesion: 0.14
...
Cohesion: 0.25
Nodes (8): Coherence, Completeness, Evaluation Dimension, Factual Accuracy, Hallucination Rate, Latency, Relevance, Style Alignment

### Community 305 - "Rhetorical and Structural Devices"
Cohesion: 0.25
Nodes (8): device_family, Amplification, Aristotelian Appeals, Balance, Comparison, Engagement, Repetition, Structural
...
Cohesion: 0.03
Nodes (157): MultiDiGraph, Pattern, PreTrainedTokenizerFast, PrimaryRelationEdge, Discourse analysis result models and graph structures., Execution timing profile in milliseconds., Complete discourse analysis result., Find the root node if present. (+149 more)

### Community 310 - "Tasks: RST Provider Adapter"
Cohesion: 0.67
...
### Community 313 - "shared_runtime_mutation_test.py"
Cohesion: 0.23
Nodes (14): parametrize, Path, The shared-runtime mutation gate distinguishes test failures from broken tests., test_missing_report_is_not_a_killed_mutant(), test_only_causal_failures_count_as_killed(), _apply_mutant(), causal_failure(), _copy_test_workspace() (+6 more)
...
Cohesion: 0.29
Nodes (7): Agentic, CAG, Fine Tuning, AI Method Type, PDL Declarative, Prompt Engineering, RAG

### Community 317 - "Toulmin Argumentation Model"
Cohesion: 0.29
...
### Community 319 - "WaltonAnalysis"
Cohesion: 0.14
Nodes (9): BaseModel, JsonValue, One argument in the passage, matched to a scheme and tested against its…, The critical questions this passage leaves unanswered — the analytical payload., Every scheme instance found in one source., SchemeInstance, WaltonAnalysis, test_walton_empty_analysis_remains_valid() (+1 more)

### Community 320 - "Toulmin Provider Specifications"
Cohesion: 0.43
Nodes (7): Specification Quality Checklist: Toulmin Provider, Contract: Native Toulmin Result, Data Model: Toulmin Provider, Implementation Plan: Toulmin Provider, Research: Toulmin Provider, Feature Specification: Toulmin Provider, Tasks: Toulmin Provider

### Community 321 - "Walton Provider Specifications"
Cohesion: 0.38
Nodes (7): Specification Quality Checklist: Walton Provider, Contract: Native Walton Result, Data Model: Walton Provider, Implementation Plan: Walton Provider, Research: Walton Provider, Feature Specification: Walton Provider, Tasks: Walton Provider

### Community 322 - "SDRT Provider Specifications"
Cohesion: 0.33
Nodes (7): Specification Quality Checklist: SDRT Provider, Native SDRT Result Contract, Data Model: SDRT Provider, Implementation Plan: SDRT Provider, Research: SDRT Provider, Feature Specification: SDRT Provider, Tasks: SDRT Provider

### Community 323 - "PDTB Provider Specifications"
Cohesion: 0.33
...
### Community 324 - "test_base_predictor.py"
Cohesion: 0.20
Nodes (14): Validate untrusted input as a sequence of EDU strings. Typed ``object`` because…, parametrize, Unit tests for BasePredictor helpers — no model downloads, fast., test_resolve_dtype_passthrough(), test_resolve_dtype_string_parsing(), test_str2bool(), test_str2bool_rejects_ambiguous_values(), test_validate_edus_bytes_raises() (+6 more)

### Community 325 - "enum"
Cohesion: 0.20
Nodes (10): enum, title, type, AnchorTargetKind, decision, edu, node, primary_edge (+2 more)

### Community 326 - "EDU File Retrieval"
Cohesion: 0.29
...
### Community 331 - "UniRST Configuration Reader"
Cohesion: 0.29
Nodes (4): ConfigReader, Any, Path, Offline UniRST training configuration reader.

### Community 332 - "Discourse Relation Senses"
Cohesion: 0.33
...
### Community 335 - "OutputFormalism"
Cohesion: 0.33
Nodes (6): OutputFormalism, erst_graph, rst_tree, enum, title, type

### Community 336 - "Markdown Linting Script"
Cohesion: 0.53
...
### Community 337 - "capabilities.schema.json"
Cohesion: 0.22
Nodes (8): additionalProperties, $id, execution, semantic, required, $schema, title, type

### Community 338 - "Discourse Parser Components"
Cohesion: 0.40
Nodes (6): AnalysisParser, Parser, ProductionIngestor, SourceArtifact, ModernBERT Discourse Parser, RstProvider

### Community 339 - "IBIS Provider Specifications"
Cohesion: 0.40
...
### Community 345 - "ExactCoverage"
Cohesion: 0.05
Nodes (45): additionalProperties, properties, required, title, type, minimum, title, type (+37 more)

### Community 346 - "Docling RST Output Planning"
Cohesion: 0.90
Nodes (5): DocLang-native RST Output Plan, Docling-native RST Output Proposal, Docling-native RST Output Build Plan, Boundary-Partitioned Long-Input Parsing Plan, Markdown-native RST Output Plan

### Community 347 - "Information Retrieval Strategies"
Cohesion: 0.40
Nodes (5): Dense Retrieval, Hybrid Retrieval, Multi Hop, Retrieval Strategy, Sparse Retrieval

### Community 348 - "Aristotelian Rhetorical Appeals"
Cohesion: 0.40
Nodes (5): aristotelian_appeal, Ethos, Kairos, Logos, Pathos

### Community 349 - "Power Level Classifications"
Cohesion: 0.40
Nodes (5): power_level, High, Low, Medium, Very High

### Community 350 - "Razdel Token Offset Converter"
Cohesion: 0.40
...
### Community 351 - "properties"
Cohesion: 0.05
Nodes (44): anyOf, default, properties, properties, $ref, const, default, title (+36 more)
...
Cohesion: 0.05
Nodes (45): Agent Instructions, Architecture Rules, Code Standards, Commands, No Assumptions Rule, UniRST Metrics, Production API Contract, Production Source Ingest (+37 more)

### Community 354 - "ExactCoverage"
Cohesion: 0.05
Nodes (44): additionalProperties, properties, required, title, type, minimum, title, type (+36 more)

### Community 355 - "Pytest Session Fixtures"
Cohesion: 0.40
...
### Community 356 - "LSTM Dropout Validation Tests"
Cohesion: 0.50
...
### Community 357 - "RDAM Schema and Configs"
Cohesion: 0.50
...
Cohesion: 0.67
Nodes (4): Nucleus Indicator, Reduce Action, Satellite Indicator, Shift Action

### Community 360 - "Argument Conflict Types"
Cohesion: 0.50
Nodes (4): Argument Conflict Type, Rebuts, Undercuts, Undermines

### Community 361 - "Argument Link Types"
Cohesion: 0.50
Nodes (4): Argument Link Type, Addressed By, Rebutted By, Supports

### Community 362 - "Discourse Roles"
Cohesion: 0.50
Nodes (4): Discourse Role, Background, Nucleus, Supportive

### Community 363 - "validate_model_release"
Cohesion: 0.08
Nodes (37): Production-safe released-model contracts and loaders., load_compatibility_redeclaration(), load_model_release(), ModelFile, ModelReleaseError, ModelReleaseManifest, peek_runtime_contract(), BaseModel (+29 more)
...
Cohesion: 0.05
Nodes (44): anyOf, default, title, anyOf, default, title, anyOf, default (+36 more)

### Community 366 - "mapping"
Cohesion: 0.29
...
### Community 368 - "_strict.py"
Cohesion: 0.02
Nodes (152): ProviderFactory, ProviderProvenance, ProviderError, RuntimeError, The only exception a provider may raise from ``analyse``; carries its typed…, The Dung provider: formal evaluation of a supplied argumentation framework…, Sha256Identity, The IBIS provider: typed issue-position-argument structure, validated under the… (+144 more)

### Community 369 - "kind"
Cohesion: 0.05
Nodes (42): additionalProperties, properties, required, title, type, title, type, ArchiveMemberAnchor (+34 more)
...
### Community 372 - "systems/common.py"
Cohesion: 0.07
Nodes (48): _protocol(), Regression tests for calibration, statistics, resources, and system constraints., _receipt(), _resource(), test_bootstrap_and_holm_are_reproducible_and_content_hashed(), test_generative_outcomes_are_unique_and_include_explicit_no_edge(), test_screening_completeness_requires_every_system_seed_disposition(), test_temperature_fit_is_deterministic_and_does_not_increase_development_nll() (+40 more)

### Community 373 - "$defs"
Cohesion: 0.05
Nodes (40): enum, title, type, enum, title, type, title, type (+32 more)
...
Cohesion: 0.05
Nodes (70): CandidateIdentityProbe, CorpusSourceIdentity, Text-free identity for one source in a private corpus checkout., Determinism evidence for one private document without candidate text., analysis_to_rs4(), Conversion utilities between RS4 DOM, DiscourseUnit, and typed contracts., Convert an RstDocument and RstAnalysis back into an RS4Document., Convert an RS4Document into an RstDocument and an RstAnalysis. (+62 more)
...
### Community 379 - "Parser Isolation Tests"
Cohesion: 0.50
...
### Community 384 - "Ingestion Documentation and Fixtures"
Cohesion: 0.67
Nodes (3): isanlp_rst.ingest, Docling JSON Fixtures README, Offline Workbench README
...
Cohesion: 0.67
Nodes (3): Dick and Carey Systems Model, Elaboration Theory, Morrison-Ross-Kemp Model

### Community 393 - "Team Dynamics and Development"
Cohesion: 0.67
Nodes (3): Icebreakers and Group Formation, Psychological Safety, Tuckman Group Development

### Community 394 - "Rhetorical Appeals"
Cohesion: 1.00
Nodes (3): Ethos Appeal, Logos Appeal, Pathos Appeal

### Community 395 - "Argument Component States"
Cohesion: 0.67
Nodes (3): Argument Component State, Stated, Unstated

### Community 396 - "Discourse Relation Explicitness"
Cohesion: 0.67
Nodes (3): Discourse Relation Explicitness, Explicit, Implied

### Community 397 - "Structural Communication Frameworks"
Cohesion: 0.67
Nodes (3): structural_framework, Monroe Sequence, SCQA

### Community 398 - "Creative Direction Assets"
Cohesion: 0.67
...
### Community 403 - "Production Environment Contracts"
Cohesion: 0.67
Nodes (3): Contract: Environments and Production Artifacts, Contract: Local Model Promotion, Quickstart: Production and Offline Boundaries

### Community 404 - "Feature 004 Convergence"
Cohesion: 0.67
Nodes (3): Feature 004 convergence handoff — 2026-08-31, Feature 004 Source Scope and SOTA Audit, Source Specification Currency Evidence

### Community 405 - "Feature Specification: ModernBERT Pure Transformer Discourse Parser Release & Operational Certification"
Cohesion: 0.40
...
Cohesion: 0.05
Nodes (40): additionalProperties, properties, required, title, type, minimum, title, type (+32 more)
...
Cohesion: 0.03
Nodes (66): FormalismChoice, Return a lower-case SHA-256 digest for immutable bytes., sha256_bytes(), field_serializer, field_validator, JsonValue, The exact native result a caller derived a structured input from (FR-015). The…, A caller-supplied structure for a formal technique (FR-016, FR-017).… (+58 more)

### Community 409 - "Data Model: Unified Machine Interfaces"
Cohesion: 0.17
Nodes (12): 10. AI-consumption records, 11. Testing, 1. Public record registry, 2. MachineConfig, 3. ProviderConfiguration and cache binding, 4. AggregateRequest, 5. Request wire representation, 6. PreparationRequest and MachinePreparation (+4 more)

### Community 410 - "Feature Specification: Shared Runtime Hardening"
Cohesion: 0.25
...
Cohesion: 0.11
Nodes (23): PromotionReceipt, BaseModel, model_validator, Self, Offline-only contracts for local model-promotion workflows., Immutable evidence for one successful local promotion., Offline creation and promotion of immutable production model releases., main() (+15 more)

### Community 416 - "test_baseline_corrections.py"
Cohesion: 0.21
Nodes (14): fixture, parametrize, Path, SourceArtifact, SourceForm, Approved repairs are proven against real historical records, never allowlisted., records(), test_corrected_to_corrected_comparison_does_not_reapply_repairs() (+6 more)

### Community 418 - "properties"
Cohesion: 0.05
Nodes (40): $ref, anyOf, default, additionalProperties, properties, title, type, $ref (+32 more)

### Community 464 - "Contract: Unified rdam CLI"
Cohesion: 0.22
Nodes (9): Acquisition and exclusivity, Commands, Common options, Configuration precedence, Contract: Unified rdam CLI, Exit statuses and precedence, Help acceptance, Output and diagnostics (+1 more)

### Community 465 - "Feature 017 implementation verification"
Cohesion: 0.06
Nodes (36): Specification Quality Checklist: Universal Source Pipeline, Contract: Execution, Cache, and Alignment, Contract: Source Pipeline, Data Model: Universal Source Pipeline, Approved design decision — 2026-09-04, Feature 017 baseline — 2026-09-03, No-compatibility checkpoint — 2026-09-04, Relocation checkpoint — T006–T018 (+28 more)

### Community 468 - "Tasks: Dung Abstract Argumentation Provider"
Cohesion: 0.40
...
### Community 469 - "Implementation Plan: Unified Machine Interfaces"
Cohesion: 0.22
Nodes (9): Complexity Tracking, Constitution Check, Design artifacts and authority, Implementation Plan: Unified Machine Interfaces, Implementation sequence, Planned source layout, Summary, Technical Context (+1 more)

### Community 470 - "ExactCoverage"
Cohesion: 0.05
...
### Community 1100 - "CriticalQuestion"
Cohesion: 0.15
Nodes (6): CriticalQuestion, model_validator, Self, One critical question and what the source does with it., test_walton_addressed_note_without_evidence_is_rejected(), TestCriticalQuestions

### Community 1101 - "type"
Cohesion: 0.06
Nodes (38): default, items, title, type, $ref, Disposition, additionalProperties, properties (+30 more)

### Community 1107 - "HierarchicalAdapter"
Cohesion: 0.17
...
### Community 1113 - "compatibility_range"
Cohesion: 0.67
Nodes (3): pattern, type, compatibility_range

### Community 1114 - "created_at"
Cohesion: 0.67
Nodes (3): format, type, created_at

### Community 1115 - "model_task"
Cohesion: 0.67
Nodes (3): const, type, model_task

### Community 1116 - "producer_version"
Cohesion: 0.67
Nodes (3): pattern, type, producer_version

### Community 1117 - "schema_version"
Cohesion: 0.67
Nodes (3): schema_version, const, type

### Community 1118 - "properties"
Cohesion: 0.05
Nodes (38): $ref, anyOf, default, const, default, title, type, const (+30 more)

### Community 1119 - "source_revision"
Cohesion: 0.67
Nodes (3): source_revision, pattern, type

### Community 1120 - "Contract: Native Analysis Integrity Corrections"
Cohesion: 0.29
Nodes (7): Contract: Native Analysis Integrity Corrections, Evidence baseline, NI-01 — Complete Walton assessments, NI-02 — Toulmin warrant origin and honest count names, NI-03 — Typed, provider-selected source alignment, NI-04 — Version, persistence, caches and historical truth, Required regression cases

### Community 1121 - "properties"
Cohesion: 0.05
Nodes (38): $ref, anyOf, default, const, default, title, type, const (+30 more)

### Community 1133 - "._resolve_dtype"
Cohesion: 0.15
Nodes (11): device, dtype, Path, Load a PyTorch state dict with ``weights_only=True``. All checkpoints published…, Compatibility façade over the shared device-aware dtype resolver., Default is fp32 on every device — measured fp32 wins on MPS for typical inputs;…, test_load_torch_weights_pure_tensors(), test_resolve_dtype_auto_uses_native_mps_half_precision() (+3 more)
...
Cohesion: 0.33
Nodes (6): Contract: Optional Local HTTP, Execution and lifecycle, Local safety and resource limits, Parity, Representation and errors, Surface

### Community 1157 - "Quickstart and Validation Guide"
Cohesion: 0.33
Nodes (6): Analytical-quality validation, Implementation checks, Prerequisites, Primary workflows, Python and HTTP parity, Quickstart and Validation Guide

### Community 1158 - "properties"
Cohesion: 0.05
Nodes (38): items, minItems, title, type, $ref, properties, $ref, minLength (+30 more)
...
### Community 1163 - "properties"
Cohesion: 0.06
Nodes (37): properties, additionalProperties, properties, title, type, $ref, AnalysedToken, title (+29 more)

### Community 1164 - "properties"
Cohesion: 0.06
Nodes (37): properties, additionalProperties, properties, title, type, $ref, AnalysedToken, title (+29 more)
...
### Community 1167 - "properties"
Cohesion: 0.06
Nodes (37): properties, additionalProperties, properties, title, type, $ref, AnalysedToken, title (+29 more)

### Community 1168 - "properties"
Cohesion: 0.06
Nodes (37): properties, additionalProperties, properties, title, type, $ref, AnalysedToken, title (+29 more)
...
Cohesion: 0.04
Nodes (55): LegacySourceContractIdentity, _canonical_edus(), ConversionActivity, _identify_path(), _media_type(), field_serializer, field_validator, model_validator (+47 more)

### Community 1171 - "properties"
Cohesion: 0.06
Nodes (35): anyOf, default, const, default, title, type, const, default (+27 more)
...
### Community 1175 - "$defs"
Cohesion: 0.06
Nodes (34): anyOf, default, enum, title, type, title, type, enum (+26 more)
...
### Community 1179 - "type"
Cohesion: 0.06
Nodes (34): default, items, title, type, $ref, Disposition, additionalProperties, properties (+26 more)

### Community 1180 - "$defs"
Cohesion: 0.06
Nodes (33): enum, title, type, title, type, discriminator, oneOf, title (+25 more)
...
### Community 1186 - "required"
Cohesion: 0.08
Nodes (33): required, required, required, required, required, boundary_reason, character_coverage, character_range (+25 more)

### Community 1187 - "required"
Cohesion: 0.08
Nodes (33): required, required, required, required, required, boundary_reason, character_coverage, character_range (+25 more)
...
Cohesion: 0.06
Nodes (33): anyOf, default, title, anyOf, default, title, anyOf, default (+25 more)

### Community 1191 - "$defs"
Cohesion: 0.08
Nodes (32): $defs, FormalismChoice, HistoricalNativeTechniqueResult, NativeTechniqueResult, SemanticVersion, SourceArtifactRef, additionalProperties, description (+24 more)

### Community 1192 - "properties"
Cohesion: 0.07
Nodes (33): items, minItems, title, type, items, properties, items, type (+25 more)
...
### Community 1197 - "Disposition"
Cohesion: 0.06
Nodes (33): default, items, title, type, $ref, Disposition, additionalProperties, properties (+25 more)

### Community 1198 - "required"
Cohesion: 0.06
Nodes (32): additionalProperties, required, title, type, additionalProperties, required, title, type (+24 more)

### Community 1199 - "required"
Cohesion: 0.06
Nodes (32): additionalProperties, required, title, type, additionalProperties, required, title, type (+24 more)

### Community 1200 - "required"
Cohesion: 0.06
Nodes (32): additionalProperties, required, title, type, additionalProperties, required, title, type (+24 more)

### Community 1201 - "required"
Cohesion: 0.06
Nodes (32): additionalProperties, required, title, type, additionalProperties, required, title, type (+24 more)

### Community 1202 - "required"
Cohesion: 0.06
Nodes (32): additionalProperties, required, title, type, additionalProperties, required, title, type (+24 more)
...
Cohesion: 0.07
Nodes (32): properties, items, title, type, anyOf, $ref, default, items (+24 more)
...
### Community 1209 - "required"
Cohesion: 0.06
Nodes (31): additionalProperties, properties, required, title, type, title, type, additionalProperties (+23 more)

### Community 1210 - "required"
Cohesion: 0.06
Nodes (31): additionalProperties, properties, required, title, type, title, type, additionalProperties (+23 more)

### Community 1211 - "required"
Cohesion: 0.06
Nodes (31): additionalProperties, properties, required, title, type, title, type, additionalProperties (+23 more)
...
Cohesion: 0.07
Nodes (31): items, title, type, $ref, items, minItems, title, type (+23 more)
...
Cohesion: 0.06
Nodes (31): additionalProperties, required, title, type, additionalProperties, required, title, type (+23 more)

### Community 1223 - "required"
Cohesion: 0.06
Nodes (31): additionalProperties, properties, required, title, type, title, type, additionalProperties (+23 more)

### Community 1224 - "required"
Cohesion: 0.06
Nodes (31): additionalProperties, required, title, type, additionalProperties, required, title, type (+23 more)

### Community 1225 - "required"
Cohesion: 0.06
Nodes (31): additionalProperties, properties, required, title, type, title, type, additionalProperties (+23 more)

### Community 1226 - "$defs"
Cohesion: 0.07
Nodes (29): enum, title, type, enum, title, type, title, type (+21 more)

### Community 1227 - "properties"
Cohesion: 0.07
Nodes (30): properties, $ref, minimum, title, type, minimum, title, type (+22 more)
...
### Community 1229 - "properties"
Cohesion: 0.07
Nodes (30): properties, $ref, minimum, title, type, minimum, title, type (+22 more)

### Community 1230 - "properties"
Cohesion: 0.07
Nodes (30): properties, $ref, minimum, title, type, minimum, title, type (+22 more)

### Community 1231 - "frozen_evaluation.py"
Cohesion: 0.05
Nodes (35): IncompatibleAdapter, Synthetic measured incompatibility proving durable unsuccessful evidence., Strict checkpoint reload and untouched-corpus inference for every harness…, BaseModel, field_validator, Successful adapter output before the runner verifies and hashes artifacts., One adapter's sandboxed output directory and read-only governed inputs., SystemExecutionResult (+27 more)

### Community 1232 - "TestCoreTriad"
Cohesion: 0.14
Nodes (4): FR-019: claim-and-premise extraction is not a Toulmin analysis., A warrant that merely repeats the claim or a ground identified no inference…, TestCoreTriad, TestWarrantIsNotRestatement

### Community 1233 - "$defs"
Cohesion: 0.07
Nodes (29): enum, title, type, enum, title, type, title, type (+21 more)

### Community 1234 - "properties"
Cohesion: 0.07
Nodes (30): properties, $ref, minimum, title, type, minimum, title, type (+22 more)
...
### Community 1236 - "properties"
Cohesion: 0.07
Nodes (30): $ref, $ref, additionalProperties, properties, required, title, type, $ref (+22 more)

### Community 1237 - "properties"
Cohesion: 0.07
Nodes (30): $ref, $ref, additionalProperties, properties, required, title, type, $ref (+22 more)

### Community 1238 - "ProviderProvenance"
Cohesion: 0.07
Nodes (30): ProviderProvenance, licence, package, version, minLength, title, type, anyOf (+22 more)

### Community 1239 - "ProviderProvenance"
Cohesion: 0.07
Nodes (30): ProviderProvenance, licence, package, version, minLength, title, type, anyOf (+22 more)

### Community 1240 - "ProviderProvenance"
Cohesion: 0.07
Nodes (30): ProviderProvenance, licence, package, version, minLength, title, type, anyOf (+22 more)

### Community 1241 - "properties"
Cohesion: 0.07
Nodes (30): default, items, title, type, $ref, $ref, default, items (+22 more)

### Community 1242 - "properties"
Cohesion: 0.07
Nodes (30): default, items, title, type, $ref, $ref, default, items (+22 more)
...
### Community 1251 - "kind"
Cohesion: 0.07
Nodes (29): FailedOutcome, HistoricalResultOutcome, LineEndingParameters, additionalProperties, properties, required, title, type (+21 more)

### Community 1252 - "properties"
Cohesion: 0.07
...
Cohesion: 0.07
Nodes (29): anyOf, default, title, anyOf, default, title, anyOf, default (+21 more)

### Community 1255 - "properties"
Cohesion: 0.07
Nodes (29): $ref, properties, $ref, maxItems, minItems, prefixItems, $ref, anyOf (+21 more)

### Community 1256 - "properties"
Cohesion: 0.07
Nodes (29): $ref, properties, $ref, maxItems, minItems, prefixItems, $ref, anyOf (+21 more)

### Community 1257 - "OutputDestination"
Cohesion: 0.22
Nodes (25): OutputDestination, Path, Sha256Identity, MonkeyPatch, parametrize, Path, Publication preserves inputs and existing results unless replacement is…, _temporaries() (+17 more)

### Community 1258 - "enum"
Cohesion: 0.07
Nodes (28): enum, enum, asset, background, caption, code, edu, field (+20 more)

### Community 1259 - "properties"
Cohesion: 0.07
Nodes (28): title, type, properties, coordinate_system, x0, x0_resolution, x1, x1_resolution (+20 more)
...
### Community 1280 - "properties"
Cohesion: 0.07
Nodes (28): title, type, properties, coordinate_system, x0, x0_resolution, x1, x1_resolution (+20 more)

### Community 1281 - "properties"
Cohesion: 0.07
Nodes (28): title, type, properties, coordinate_system, x0, x0_resolution, x1, x1_resolution (+20 more)
...
### Community 1299 - "verify_model_licensing.py"
Cohesion: 0.36
...
### Community 1302 - "ArchiveMemberAnchor"
Cohesion: 0.08
Nodes (27): additionalProperties, properties, required, title, type, title, type, ArchiveMemberAnchor (+19 more)

### Community 1303 - "CrossReferenceRepresentation"
Cohesion: 0.08
Nodes (27): additionalProperties, properties, required, title, type, CrossReferenceRepresentation, ItemRelationship, additionalProperties (+19 more)

### Community 1304 - "properties"
Cohesion: 0.08
Nodes (27): anyOf, anyOf, properties, properties, anyOf, $ref, anyOf, anyOf (+19 more)

### Community 1305 - "properties"
Cohesion: 0.07
Nodes (27): additionalProperties, properties, required, title, type, AnalysisCapacity, minLength, title (+19 more)

### Community 1306 - "properties"
Cohesion: 0.08
Nodes (27): anyOf, anyOf, properties, properties, anyOf, $ref, anyOf, anyOf (+19 more)
...
### Community 1308 - "CrossReferenceRepresentation"
Cohesion: 0.08
Nodes (27): additionalProperties, properties, required, title, type, CrossReferenceRepresentation, ItemRelationship, additionalProperties (+19 more)

### Community 1309 - "CrossReferenceRepresentation"
Cohesion: 0.08
Nodes (27): additionalProperties, properties, required, title, type, CrossReferenceRepresentation, ItemRelationship, additionalProperties (+19 more)
...
### Community 1318 - "kind"
Cohesion: 0.08
Nodes (26): FailedOutcome, HistoricalResultOutcome, LineEndingParameters, additionalProperties, properties, required, title, type (+18 more)

### Community 1319 - "contract"
Cohesion: 0.08
Nodes (26): items, title, type, const, default, title, type, properties (+18 more)

### Community 1320 - "properties"
Cohesion: 0.08
Nodes (26): properties, anyOf, default, $ref, title, type, minimum, title (+18 more)

### Community 1321 - "properties"
Cohesion: 0.08
Nodes (26): properties, anyOf, default, $ref, title, type, minimum, title (+18 more)
...
### Community 1323 - "PreparedRange"
Cohesion: 0.09
Nodes (26): PreparedRange, TextSpanAnchor, exclusiveMinimum, title, type, end, start, additionalProperties (+18 more)

### Community 1324 - "PreparedRange"
Cohesion: 0.09
Nodes (26): PreparedRange, TextSpanAnchor, exclusiveMinimum, title, type, end, start, additionalProperties (+18 more)

### Community 1325 - "ProviderProvenance"
Cohesion: 0.08
Nodes (26): ProviderProvenance, licence, package, version, minLength, title, type, anyOf (+18 more)

### Community 1326 - "ProviderProvenance"
Cohesion: 0.08
Nodes (26): ProviderProvenance, licence, package, version, minLength, title, type, anyOf (+18 more)
...
### Community 1329 - "capacity"
Cohesion: 0.08
Nodes (26): properties, anyOf, exclusiveMinimum, $ref, title, type, complete, partial (+18 more)

### Community 1330 - "capacity"
Cohesion: 0.08
Nodes (26): properties, anyOf, exclusiveMinimum, $ref, title, type, complete, partial (+18 more)

### Community 1331 - "properties"
Cohesion: 0.08
Nodes (25): $ref, anyOf, default, const, default, title, type, HistoricalNativeTechniqueResult (+17 more)
...
### Community 1333 - "machine-dung-input.validation.schema.json"
Cohesion: 0.08
Nodes (24): additionalProperties, items, minItems, title, type, items, title, type (+16 more)

### Community 1334 - "semantic_digest"
Cohesion: 0.08
Nodes (25): additionalProperties, properties, required, title, type, const, default, title (+17 more)

### Community 1335 - "semantic_digest"
Cohesion: 0.08
Nodes (25): additionalProperties, properties, required, title, type, const, default, title (+17 more)
...
### Community 1338 - "$defs"
Cohesion: 0.08
Nodes (25): $defs, SemanticVersion, SourceAnchor, SourcePathAnchor, mapping, propertyName, path, path_kind (+17 more)
...
### Community 1341 - "required"
Cohesion: 0.09
Nodes (24): additionalProperties, required, title, type, additionalProperties, required, title, type (+16 more)

### Community 1342 - "properties"
Cohesion: 0.09
Nodes (24): items, title, type, $ref, type, items, title, type (+16 more)

### Community 1343 - "ProviderConfiguration"
Cohesion: 0.08
Nodes (24): $ref, title, type, minLength, title, type, ProviderConfiguration, anyOf (+16 more)

### Community 1344 - "AnnotationRepresentation"
Cohesion: 0.08
Nodes (24): additionalProperties, properties, required, title, type, default, items, title (+16 more)

### Community 1345 - "AnnotationRepresentation"
Cohesion: 0.08
Nodes (24): additionalProperties, properties, required, title, type, default, items, title (+16 more)

### Community 1346 - "properties"
Cohesion: 0.09
Nodes (24): items, title, type, $ref, items, minItems, title, type (+16 more)

### Community 1347 - "properties"
Cohesion: 0.09
Nodes (24): items, title, type, $ref, items, minItems, title, type (+16 more)

### Community 1348 - "properties"
Cohesion: 0.09
Nodes (23): const, default, title, type, const, default, title, type (+15 more)

### Community 1349 - "properties"
Cohesion: 0.09
Nodes (23): const, default, title, type, const, default, title, type (+15 more)

### Community 1350 - "required"
Cohesion: 0.09
Nodes (23): additionalProperties, required, title, type, enum, title, type, ContentInventoryItem (+15 more)

### Community 1351 - "required"
Cohesion: 0.09
Nodes (23): additionalProperties, required, title, type, enum, title, type, ContentInventoryItem (+15 more)

### Community 1352 - "load_contract"
Cohesion: 0.04
Nodes (91): PersistedContract, ProductionIngestError, cache_entry_identity(), Path, ProductionAnalysisOutcome, Sha256Identity, Integrity-checked atomic cache for semantically eligible v2 outcomes., Bind one cache entry to exactly one request and one validated result. (+83 more)
...
### Community 1355 - "required"
Cohesion: 0.10
Nodes (22): required, required, ExcludedOutcome, HistoricalNativeTechniqueResult, additionalProperties, required, title, type (+14 more)

### Community 1356 - "$defs"
Cohesion: 0.09
Nodes (22): enum, title, type, discriminator, oneOf, $defs, Availability, CapabilityState (+14 more)

### Community 1357 - "properties"
Cohesion: 0.09
Nodes (22): $ref, SourceFormCapability, accepted_media_types, availability, missing_distributions, preparation_supported, required_extra, source_form (+14 more)

### Community 1358 - "ContractSupport"
Cohesion: 0.09
Nodes (22): const, default, title, type, additionalProperties, properties, required, title (+14 more)

### Community 1359 - "artifact_identity"
Cohesion: 0.10
Nodes (22): additionalProperties, required, title, type, ArchiveMemberAnchor, PageBoxAnchor, required, artifact_identity (+14 more)

### Community 1360 - "PreparedRange"
Cohesion: 0.10
...
### Community 1362 - "kind"
Cohesion: 0.10
Nodes (22): properties, title, type, ItemAnchor, title, type, additionalProperties, properties (+14 more)

### Community 1363 - "artifact_identity"
Cohesion: 0.10
Nodes (22): additionalProperties, required, title, type, ArchiveMemberAnchor, PageBoxAnchor, required, artifact_identity (+14 more)

### Community 1364 - "artifact_identity"
Cohesion: 0.10
Nodes (22): additionalProperties, required, title, type, ArchiveMemberAnchor, PageBoxAnchor, required, artifact_identity (+14 more)
...
### Community 1368 - "MediaReferenceRepresentation"
Cohesion: 0.09
Nodes (22): anyOf, default, title, MediaReferenceRepresentation, anyOf, default, title, media_identity (+14 more)

### Community 1369 - "required"
Cohesion: 0.10
Nodes (22): additionalProperties, required, title, type, ArchiveMemberAnchor, PageBoxAnchor, required, artifact_identity (+14 more)

### Community 1370 - "_version.py"
Cohesion: 0.18
...
### Community 1371 - "._guess_token_offsets"
Cohesion: 0.17
...
### Community 1372 - "AnalysisReadingGuide"
Cohesion: 0.10
...
Cohesion: 0.10
Nodes (21): additionalProperties, description, required, title, type, ContentInventory, HistoricalNativeTechniqueResult, additionalProperties (+13 more)
...
### Community 1383 - "required"
Cohesion: 0.10
Nodes (21): additionalProperties, required, title, type, required, AnalysisPlan, analysed_document, analysis (+13 more)

### Community 1384 - "properties"
Cohesion: 0.10
Nodes (21): additionalProperties, properties, title, type, AnalysisAnchor, source_endpoint, supporting_signal_ids, target_endpoint (+13 more)

### Community 1385 - "required"
Cohesion: 0.10
Nodes (21): additionalProperties, required, title, type, required, AnalysisPlan, analysed_document, analysis (+13 more)

### Community 1386 - "properties"
Cohesion: 0.10
Nodes (21): anyOf, default, title, type, const, title, type, enum (+13 more)

### Community 1387 - "properties"
Cohesion: 0.10
Nodes (21): anyOf, default, title, type, const, title, type, enum (+13 more)

### Community 1388 - "properties"
Cohesion: 0.10
Nodes (21): minLength, title, type, anyOf, default, title, minLength, title (+13 more)

### Community 1389 - "properties"
Cohesion: 0.10
Nodes (21): minLength, title, type, properties, anyOf, default, title, activity_id (+13 more)

### Community 1390 - "properties"
Cohesion: 0.10
Nodes (21): minLength, title, type, properties, anyOf, default, title, activity_id (+13 more)
...
### Community 1392 - "required"
Cohesion: 0.10
Nodes (21): additionalProperties, required, title, type, required, AnalysisPlan, analysed_document, analysis (+13 more)

### Community 1393 - "properties"
Cohesion: 0.10
Nodes (21): additionalProperties, properties, title, type, AnalysisAnchor, source_endpoint, supporting_signal_ids, target_endpoint (+13 more)

### Community 1394 - "required"
Cohesion: 0.10
Nodes (21): additionalProperties, required, title, type, required, AnalysisPlan, analysed_document, analysis (+13 more)

### Community 1395 - "capacity"
Cohesion: 0.10
Nodes (20): properties, anyOf, exclusiveMinimum, $ref, title, type, $ref, capacity (+12 more)
...
### Community 1398 - "capacity"
Cohesion: 0.10
Nodes (20): properties, anyOf, exclusiveMinimum, $ref, title, type, $ref, capacity (+12 more)

### Community 1399 - "capacity"
Cohesion: 0.10
Nodes (20): properties, anyOf, exclusiveMinimum, $ref, title, type, $ref, capacity (+12 more)

### Community 1400 - "$defs"
Cohesion: 0.10
Nodes (20): $defs, PageBoxAnchor, ProviderProvenance, SemanticVersion, SourceAnchor, licence, package, version (+12 more)

### Community 1401 - "TextSpan"
Cohesion: 0.10
Nodes (20): TextSpan, exclusiveMinimum, title, type, end, start, text, end (+12 more)

### Community 1402 - "TextSpan"
Cohesion: 0.10
Nodes (20): TextSpan, exclusiveMinimum, title, type, end, start, text, end (+12 more)

### Community 1403 - "properties"
Cohesion: 0.10
Nodes (20): const, default, title, type, const, default, title, type (+12 more)

### Community 1404 - "properties"
Cohesion: 0.10
Nodes (20): const, default, title, type, const, default, title, type (+12 more)
...
### Community 1407 - "AnalysisReadingGuide"
Cohesion: 0.10
Nodes (20): additionalProperties, properties, required, title, type, AnalysisReadingGuide, items, title (+12 more)

### Community 1408 - "mapping"
Cohesion: 0.11
...
### Community 1412 - "type"
Cohesion: 0.14
Nodes (19): items, title, type, properties, items, title, type, items (+11 more)

### Community 1413 - "type"
Cohesion: 0.14
Nodes (19): items, title, type, properties, items, title, type, items (+11 more)

### Community 1414 - "IbisInputLink"
Cohesion: 0.11
...
### Community 1418 - "properties"
Cohesion: 0.11
Nodes (19): items, minItems, title, type, default, items, title, type (+11 more)

### Community 1419 - "properties"
Cohesion: 0.11
Nodes (19): items, minItems, title, type, default, items, title, type (+11 more)

### Community 1420 - "properties"
Cohesion: 0.11
Nodes (19): anyOf, default, const, default, title, type, const, default (+11 more)
...
### Community 1423 - "AvailableCapability"
Cohesion: 0.11
Nodes (19): additionalProperties, properties, required, title, type, $ref, AvailableCapability, contract_version (+11 more)

### Community 1424 - "required"
Cohesion: 0.12
Nodes (19): HistoricalResultSourceAlignment, ResultSourceAlignment, additionalProperties, description, required, title, type, contributing_item_ids (+11 more)

### Community 1425 - "version"
Cohesion: 0.11
Nodes (19): RawContractDeclaration, anyOf, default, title, namespace, schema_name, version, additionalProperties (+11 more)

### Community 1426 - "required"
Cohesion: 0.12
Nodes (19): HistoricalResultSourceAlignment, ResultSourceAlignment, additionalProperties, description, required, title, type, contributing_item_ids (+11 more)

### Community 1427 - "version"
Cohesion: 0.11
Nodes (19): RawContractDeclaration, anyOf, default, title, namespace, schema_name, version, additionalProperties (+11 more)

### Community 1428 - "properties"
Cohesion: 0.11
Nodes (19): minimum, title, type, minimum, title, type, $ref, properties (+11 more)

### Community 1429 - "properties"
Cohesion: 0.11
Nodes (19): minimum, title, type, minimum, title, type, $ref, properties (+11 more)

### Community 1430 - "mapping"
Cohesion: 0.11
Nodes (19): discriminator, oneOf, discriminator, oneOf, CapabilityState, ContentRepresentation, mapping, propertyName (+11 more)

### Community 1431 - "mapping"
Cohesion: 0.11
Nodes (19): discriminator, oneOf, discriminator, oneOf, CapabilityState, ContentRepresentation, mapping, propertyName (+11 more)

### Community 1432 - "properties"
Cohesion: 0.11
Nodes (19): minimum, title, type, $ref, properties, minimum, title, type (+11 more)

### Community 1433 - "properties"
Cohesion: 0.11
Nodes (19): minimum, title, type, $ref, properties, minimum, title, type (+11 more)

### Community 1434 - "BasePredictor"
Cohesion: 0.08
Nodes (23): AbstractContextManager, BasePredictor, Any, T, Recursively remap ``.start``/``.end`` of leaf/internal nodes from the tokenized…, Map an inferred tree onto authoritative predefined-EDU spans. Transformer…, Given word span boundaries, recount for subwords., Concatenate `edus` with single-space separators and return the joined text plus… (+15 more)

### Community 1435 - "required"
Cohesion: 0.11
Nodes (18): additionalProperties, required, title, type, enum, title, type, ContentInventoryItem (+10 more)

### Community 1436 - "required"
Cohesion: 0.11
Nodes (18): additionalProperties, required, title, type, enum, title, type, ContentInventoryItem (+10 more)

### Community 1437 - "required"
Cohesion: 0.11
Nodes (18): additionalProperties, required, title, type, enum, title, type, ContentInventoryItem (+10 more)

### Community 1438 - "required"
Cohesion: 0.11
Nodes (18): additionalProperties, required, title, type, enum, title, type, ContentInventoryItem (+10 more)

### Community 1439 - "required"
Cohesion: 0.11
Nodes (18): additionalProperties, required, title, type, enum, title, type, ContentInventoryItem (+10 more)
...
### Community 1446 - "SourceIdentity"
Cohesion: 0.11
Nodes (18): SourceIdentity, source_id, anyOf, default, title, media_type, source_id, source_name (+10 more)

### Community 1447 - "artifact_identity"
Cohesion: 0.12
Nodes (18): additionalProperties, required, title, type, ArchiveMemberAnchor, required, artifact_identity, bottom (+10 more)

### Community 1448 - "SourceIdentity"
Cohesion: 0.11
Nodes (18): SourceIdentity, source_id, anyOf, default, title, media_type, source_id, source_name (+10 more)

### Community 1449 - "SourcePathAnchor"
Cohesion: 0.11
Nodes (18): SourcePathAnchor, json_pointer, line, path, path_kind, xml_path, enum, title (+10 more)

### Community 1450 - "SourceIdentity"
Cohesion: 0.11
Nodes (18): SourceIdentity, source_id, anyOf, default, title, media_type, source_id, source_name (+10 more)

### Community 1451 - "SourceIdentity"
Cohesion: 0.11
Nodes (18): SourceIdentity, source_id, anyOf, default, title, media_type, source_id, source_name (+10 more)

### Community 1452 - "properties"
Cohesion: 0.11
Nodes (18): type, $ref, properties, extraction, relation_count, relation_type_counts, relations, $ref (+10 more)

### Community 1453 - "properties"
Cohesion: 0.11
Nodes (18): type, $ref, properties, extraction, relation_count, relation_type_counts, relations, $ref (+10 more)

### Community 1454 - "media_type"
Cohesion: 0.11
Nodes (18): anyOf, default, minLength, title, type, media_type, source_id, source_name (+10 more)

### Community 1455 - "media_type"
Cohesion: 0.11
Nodes (18): anyOf, default, minLength, title, type, media_type, source_id, source_name (+10 more)
...
### Community 1464 - "ArchiveMemberAnchor"
Cohesion: 0.11
Nodes (18): additionalProperties, properties, title, type, title, type, ArchiveMemberAnchor, const (+10 more)

### Community 1465 - "AnalysisReadingGuide"
Cohesion: 0.12
Nodes (17): additionalProperties, properties, required, title, type, AnalysisReadingGuide, $ref, Completion means requested analyses returned results, not that their conclusions are true. (+9 more)

### Community 1466 - "Sha256Identity"
Cohesion: 0.12
Nodes (17): const, default, title, type, Sha256Identity, pattern, title, type (+9 more)
...
### Community 1469 - "properties"
Cohesion: 0.13
Nodes (17): $ref, pattern, title, type, properties, capability, formalism_id, requires_structured_input (+9 more)

### Community 1470 - "Sha256Identity"
Cohesion: 0.12
Nodes (17): const, default, title, type, Sha256Identity, pattern, title, type (+9 more)

### Community 1471 - "properties"
Cohesion: 0.13
Nodes (17): $ref, pattern, title, type, properties, capability, formalism_id, requires_structured_input (+9 more)

### Community 1472 - "Sha256Identity"
Cohesion: 0.12
Nodes (17): const, default, title, type, Sha256Identity, pattern, title, type (+9 more)
...
Cohesion: 0.12
Nodes (17): LlmSettings, additionalProperties, properties, title, type, minimum, title, type (+9 more)

### Community 1475 - "LlmSettings"
Cohesion: 0.12
Nodes (17): LlmSettings, additionalProperties, properties, title, type, minimum, title, type (+9 more)

### Community 1476 - "Sha256Identity"
Cohesion: 0.12
Nodes (17): const, default, title, type, Sha256Identity, pattern, title, type (+9 more)

### Community 1477 - "Sha256Identity"
Cohesion: 0.12
Nodes (17): const, default, title, type, Sha256Identity, pattern, title, type (+9 more)

### Community 1478 - "Sha256Identity"
Cohesion: 0.12
Nodes (17): const, default, title, type, Sha256Identity, pattern, title, type (+9 more)

### Community 1479 - "Sha256Identity"
Cohesion: 0.12
Nodes (17): const, default, title, type, Sha256Identity, pattern, title, type (+9 more)

### Community 1480 - "properties"
Cohesion: 0.12
Nodes (17): properties, pattern, title, type, minLength, title, type, minimum (+9 more)

### Community 1481 - "properties"
Cohesion: 0.12
Nodes (17): properties, pattern, title, type, minLength, title, type, minimum (+9 more)

### Community 1482 - "Sha256Identity"
Cohesion: 0.12
Nodes (17): const, default, title, type, Sha256Identity, pattern, title, type (+9 more)

### Community 1483 - "Sha256Identity"
Cohesion: 0.12
Nodes (17): const, default, title, type, Sha256Identity, pattern, title, type (+9 more)

### Community 1484 - "ListRepresentation"
Cohesion: 0.12
Nodes (17): ListRepresentation, title, items, ordered, additionalProperties, properties, required, title (+9 more)

### Community 1485 - "ListRepresentation"
Cohesion: 0.12
Nodes (17): ListRepresentation, title, items, ordered, additionalProperties, properties, required, title (+9 more)

### Community 1486 - "Sha256Identity"
Cohesion: 0.12
Nodes (17): const, default, title, type, Sha256Identity, pattern, title, type (+9 more)

### Community 1487 - "Sha256Identity"
Cohesion: 0.12
Nodes (17): const, default, title, type, Sha256Identity, pattern, title, type (+9 more)

### Community 1488 - "properties"
Cohesion: 0.12
Nodes (17): properties, pattern, title, type, minLength, title, type, minimum (+9 more)

### Community 1489 - "properties"
Cohesion: 0.12
Nodes (17): properties, pattern, title, type, minLength, title, type, minimum (+9 more)

### Community 1490 - "properties"
Cohesion: 0.12
Nodes (17): properties, pattern, title, type, minLength, title, type, minimum (+9 more)

### Community 1491 - "properties"
Cohesion: 0.12
Nodes (17): properties, pattern, title, type, minLength, title, type, minimum (+9 more)

### Community 1492 - "properties"
Cohesion: 0.12
Nodes (17): properties, pattern, title, type, minLength, title, type, minimum (+9 more)

### Community 1493 - "properties"
Cohesion: 0.12
Nodes (17): properties, pattern, title, type, minLength, title, type, minimum (+9 more)

### Community 1494 - "$ref"
Cohesion: 0.12
Nodes (17): items, title, type, items, title, type, items, title (+9 more)

### Community 1495 - "enum"
Cohesion: 0.12
Nodes (17): SchemeId, ad_hominem, analogy, cause_to_effect, consequences, example, expert_opinion, popular_opinion (+9 more)

### Community 1496 - "properties"
Cohesion: 0.12
Nodes (17): properties, pattern, title, type, minLength, title, type, minimum (+9 more)

### Community 1497 - "required"
Cohesion: 0.14
...
### Community 1498 - "properties"
Cohesion: 0.12
Nodes (17): properties, pattern, title, type, minLength, title, type, minimum (+9 more)

### Community 1499 - "properties"
Cohesion: 0.12
Nodes (17): properties, pattern, title, type, minLength, title, type, minimum (+9 more)
...
### Community 1502 - "properties"
Cohesion: 0.12
Nodes (17): properties, pattern, title, type, minLength, title, type, minimum (+9 more)

### Community 1503 - "required"
Cohesion: 0.14
Nodes (17): required, addressed_count, conclusion, critical_questions, extraction, instance_count, instances, not_assessable_count (+9 more)

### Community 1504 - "DiscourseSignal"
Cohesion: 0.08
Nodes (33): DiscourseSignal, BaseModel, field_validator, Require unique non-negative token identifiers without reordering., Require valid half-open anchors while retaining overlap and order., Require non-empty, unique raw relation labels., Immutable identity of the detector or source that produced a signal., Typed, anchored discourse signal; overlaps are explicitly permitted. (+25 more)

### Community 1505 - "properties"
Cohesion: 0.12
Nodes (16): properties, anyOf, exclusiveMinimum, title, type, $ref, capacity, policy (+8 more)

### Community 1506 - "properties"
Cohesion: 0.12
Nodes (16): properties, anyOf, exclusiveMinimum, title, type, $ref, capacity, policy (+8 more)

### Community 1507 - "contract_version"
Cohesion: 0.12
Nodes (16): additionalProperties, properties, title, type, const, default, $ref, title (+8 more)

### Community 1508 - "required"
Cohesion: 0.13
Nodes (16): required, required, HistoricalNativeTechniqueResult, additionalProperties, description, required, title, type (+8 more)
...
### Community 1525 - "TableCoordinateAnchor"
Cohesion: 0.12
Nodes (16): minimum, title, type, TableCoordinateAnchor, column, row, column, row (+8 more)

### Community 1526 - "$defs"
Cohesion: 0.12
Nodes (16): $defs, JsonScalar, JsonValue, SemanticVersion, SourcePathAnchor, path, path_kind, anyOf (+8 more)
...
### Community 1529 - "PreparedRange"
Cohesion: 0.12
Nodes (16): PreparedRange, exclusiveMinimum, title, type, end, start, additionalProperties, properties (+8 more)

### Community 1530 - "PreparedRange"
Cohesion: 0.12
Nodes (16): PreparedRange, exclusiveMinimum, title, type, end, start, additionalProperties, properties (+8 more)

### Community 1531 - "properties"
Cohesion: 0.12
Nodes (16): $ref, $ref, properties, minimum, title, type, additionalProperties, title (+8 more)

### Community 1532 - "properties"
Cohesion: 0.12
Nodes (16): $ref, $ref, properties, minimum, title, type, additionalProperties, title (+8 more)
...
### Community 1535 - "enum"
Cohesion: 0.16
Nodes (15): Relation, required, generalizes, is_suggested_by, objects_to, positions, questions, raised_by (+7 more)

### Community 1536 - "enum"
Cohesion: 0.16
Nodes (15): Relation, required, generalizes, is_suggested_by, objects_to, positions, questions, raised_by (+7 more)

### Community 1537 - "machine-native-result.serialization.schema.json"
Cohesion: 0.13
Nodes (14): additionalProperties, description, $id, formalism_id, payload, provenance, provider_contract_version, provider_id (+6 more)

### Community 1538 - "machine-native-result-v1.serialization.schema.json"
Cohesion: 0.13
Nodes (14): additionalProperties, description, $id, formalism_id, payload, provenance, provider_contract_version, provider_id (+6 more)

### Community 1539 - "machine-native-result-v1.validation.schema.json"
Cohesion: 0.13
Nodes (14): additionalProperties, description, $id, formalism_id, payload, provenance, provider_contract_version, provider_id (+6 more)

### Community 1540 - "machine-native-result.validation.schema.json"
Cohesion: 0.13
Nodes (14): additionalProperties, description, $id, formalism_id, payload, provenance, provider_contract_version, provider_id (+6 more)

### Community 1541 - "required"
Cohesion: 0.13
Nodes (14): additionalProperties, $id, cdu_count, cdus, edu_count, edus, extraction, relation_count (+6 more)

### Community 1542 - "edus"
Cohesion: 0.13
Nodes (15): items, title, type, items, minItems, title, type, $ref (+7 more)

### Community 1543 - "required"
Cohesion: 0.13
Nodes (14): additionalProperties, $id, cdu_count, cdus, edu_count, edus, extraction, relation_count (+6 more)
...
### Community 1545 - "Rebuttal"
Cohesion: 0.13
Nodes (15): description, $ref, Rebuttal, condition, condition, source_text, additionalProperties, description (+7 more)

### Community 1546 - "properties"
Cohesion: 0.13
Nodes (15): $ref, minimum, title, type, items, title, type, properties (+7 more)

### Community 1547 - "Rebuttal"
Cohesion: 0.13
Nodes (15): description, $ref, Rebuttal, condition, condition, source_text, additionalProperties, description (+7 more)

### Community 1548 - "properties"
Cohesion: 0.13
Nodes (15): $ref, minimum, title, type, minimum, title, type, items (+7 more)

### Community 1549 - "Rebuttal"
Cohesion: 0.13
Nodes (15): description, $ref, Rebuttal, condition, condition, source_text, additionalProperties, description (+7 more)

### Community 1550 - "properties"
Cohesion: 0.13
Nodes (15): $ref, minimum, title, type, minimum, title, type, items (+7 more)

### Community 1551 - "Rebuttal"
Cohesion: 0.13
Nodes (15): description, $ref, Rebuttal, condition, condition, source_text, additionalProperties, description (+7 more)

### Community 1552 - "properties"
Cohesion: 0.13
Nodes (15): $ref, minimum, title, type, items, title, type, properties (+7 more)

### Community 1553 - "AnnotationRepresentation"
Cohesion: 0.14
Nodes (14): additionalProperties, properties, required, title, type, AnnotationRepresentation, label, title (+6 more)

### Community 1554 - "AnnotationRepresentation"
Cohesion: 0.14
Nodes (14): additionalProperties, properties, required, title, type, AnnotationRepresentation, label, title (+6 more)

### Community 1555 - "required"
Cohesion: 0.14
Nodes (14): additionalProperties, required, title, type, CoordinateBoxAnchor, coordinate_system, x0, x0_resolution (+6 more)

### Community 1556 - "AnnotationRepresentation"
Cohesion: 0.14
Nodes (14): additionalProperties, properties, required, title, type, AnnotationRepresentation, label, title (+6 more)

### Community 1557 - "required"
Cohesion: 0.14
Nodes (14): additionalProperties, required, title, type, CoordinateBoxAnchor, coordinate_system, x0, x0_resolution (+6 more)

### Community 1558 - "AnnotationRepresentation"
Cohesion: 0.14
Nodes (14): additionalProperties, properties, required, title, type, AnnotationRepresentation, label, title (+6 more)

### Community 1559 - "AnnotationRepresentation"
Cohesion: 0.14
Nodes (14): additionalProperties, properties, required, title, type, AnnotationRepresentation, label, title (+6 more)

### Community 1560 - "AnnotationRepresentation"
Cohesion: 0.14
Nodes (14): additionalProperties, properties, required, title, type, AnnotationRepresentation, label, title (+6 more)

### Community 1561 - "UnavailableCapability"
Cohesion: 0.14
Nodes (14): UnavailableCapability, reason, reason, state, $ref, const, default, title (+6 more)

### Community 1562 - "UnavailableCapability"
Cohesion: 0.14
Nodes (14): UnavailableCapability, reason, reason, state, $ref, const, default, title (+6 more)

### Community 1563 - "UnavailableCapability"
Cohesion: 0.14
Nodes (14): UnavailableCapability, reason, reason, state, $ref, const, default, title (+6 more)

### Community 1564 - "UnavailableCapability"
Cohesion: 0.14
Nodes (14): UnavailableCapability, reason, reason, state, $ref, const, default, title (+6 more)

### Community 1565 - "items"
Cohesion: 0.14
Nodes (14): items, minItems, title, type, items, title, type, properties (+6 more)

### Community 1566 - "items"
Cohesion: 0.14
Nodes (14): items, minItems, title, type, items, title, type, properties (+6 more)

### Community 1567 - "AdapterExecutionIdentity"
Cohesion: 0.14
Nodes (14): additionalProperties, properties, required, title, type, AdapterExecutionIdentity, title, type (+6 more)

### Community 1568 - "AdapterExecutionIdentity"
Cohesion: 0.14
Nodes (14): additionalProperties, properties, required, title, type, AdapterExecutionIdentity, title, type (+6 more)

### Community 1569 - "DerivedFromRecord"
Cohesion: 0.14
Nodes (14): DerivedFromRecord, additionalProperties, properties, required, title, type, result_identity, technique (+6 more)

### Community 1570 - "DerivedFromRecord"
Cohesion: 0.14
Nodes (14): DerivedFromRecord, additionalProperties, properties, required, title, type, result_identity, technique (+6 more)

### Community 1571 - "required"
Cohesion: 0.14
Nodes (14): additionalProperties, required, title, type, CoordinateBoxAnchor, coordinate_system, x0, x0_resolution (+6 more)

### Community 1572 - "required"
Cohesion: 0.14
Nodes (14): additionalProperties, required, title, type, CoordinateBoxAnchor, coordinate_system, x0, x0_resolution (+6 more)

### Community 1573 - "required"
Cohesion: 0.14
Nodes (14): additionalProperties, required, title, type, CoordinateBoxAnchor, coordinate_system, x0, x0_resolution (+6 more)
...
### Community 1575 - "enum"
Cohesion: 0.14
Nodes (14): analyse, capabilities, configuration, prepare, publish, schema, serve, summary (+6 more)

### Community 1576 - "enum"
Cohesion: 0.14
Nodes (14): analyse, capabilities, configuration, prepare, publish, schema, serve, summary (+6 more)

### Community 1577 - "required"
Cohesion: 0.14
Nodes (14): additionalProperties, required, title, type, CoordinateBoxAnchor, coordinate_system, x0, x0_resolution (+6 more)

### Community 1578 - "required"
Cohesion: 0.14
Nodes (14): additionalProperties, required, title, type, CoordinateBoxAnchor, coordinate_system, x0, x0_resolution (+6 more)
...
### Community 1583 - "$defs"
Cohesion: 0.14
Nodes (14): $defs, NonEmpty, RelationStructure, UnitId, coordinating, subordinating, minLength, type (+6 more)

### Community 1584 - "$defs"
Cohesion: 0.14
Nodes (14): $defs, NonEmpty, RelationStructure, UnitId, coordinating, subordinating, minLength, type (+6 more)

### Community 1585 - "required"
Cohesion: 0.19
Nodes (14): enum, backing, claim, elements_present, grounds, is_qualified, qualifier, rebuttal (+6 more)

### Community 1586 - "required"
Cohesion: 0.19
Nodes (14): enum, backing, claim, elements_present, grounds, is_qualified, qualifier, rebuttal (+6 more)

### Community 1587 - "AnnotationRepresentation"
Cohesion: 0.14
Nodes (14): additionalProperties, properties, required, title, type, AnnotationRepresentation, label, title (+6 more)

### Community 1588 - "AnnotationRepresentation"
Cohesion: 0.14
Nodes (14): additionalProperties, properties, required, title, type, AnnotationRepresentation, label, title (+6 more)

### Community 1589 - "machine-walton-result.serialization.schema.json"
Cohesion: 0.14
Nodes (13): additionalProperties, $defs, InstanceOutput, NonEmpty, $id, additionalProperties, title, type (+5 more)

### Community 1590 - "properties"
Cohesion: 0.14
Nodes (14): minimum, title, type, anyOf, index, note, question, reason (+6 more)

### Community 1591 - "properties"
Cohesion: 0.14
Nodes (14): $ref, minimum, title, type, properties, extraction, instance_count, scheme_set (+6 more)

### Community 1592 - "properties"
Cohesion: 0.14
Nodes (14): $ref, minimum, title, type, properties, extraction, instance_count, scheme_set (+6 more)

### Community 1593 - "machine-walton-result.validation.schema.json"
Cohesion: 0.14
Nodes (13): additionalProperties, $defs, InstanceOutput, NonEmpty, $id, additionalProperties, title, type (+5 more)

### Community 1594 - "properties"
Cohesion: 0.14
Nodes (14): minimum, title, type, anyOf, index, note, question, reason (+6 more)

### Community 1595 - "contributing_item_ids"
Cohesion: 0.15
Nodes (13): items, minItems, title, type, HistoricalResultSourceAlignment, additionalProperties, description, properties (+5 more)

### Community 1596 - "machine-capabilities.serialization.schema.json"
Cohesion: 0.15
Nodes (12): additionalProperties, description, $id, configurations, contracts, http_available, source_forms, techniques (+4 more)
...
### Community 1600 - "machine-capabilities.validation.schema.json"
Cohesion: 0.15
Nodes (12): additionalProperties, description, $id, configurations, contracts, http_available, source_forms, techniques (+4 more)
...
### Community 1602 - "properties"
Cohesion: 0.15
Nodes (13): properties, exclusiveMinimum, title, type, const, title, type, capacity (+5 more)

### Community 1603 - "properties"
Cohesion: 0.15
Nodes (13): properties, exclusiveMinimum, title, type, const, title, type, capacity (+5 more)

### Community 1604 - "required"
Cohesion: 0.15
Nodes (13): additionalProperties, required, title, type, AnalysisSubstrateTransformation, affected_ranges, algorithm, algorithm_version (+5 more)

### Community 1605 - "required"
Cohesion: 0.15
Nodes (13): additionalProperties, required, title, type, AnalysisSubstrateTransformation, affected_ranges, algorithm, algorithm_version (+5 more)
...
### Community 1607 - "properties"
Cohesion: 0.15
Nodes (13): items, title, type, items, title, type, properties, items (+5 more)
...
### Community 1610 - "required"
Cohesion: 0.15
Nodes (13): ResultSourceAlignment, contributing_item_ids, payload_path, prepared_range, projection_identity, quote, relationship, source_anchors (+5 more)

### Community 1611 - "enum"
Cohesion: 0.15
Nodes (13): Technique, dung, erst, ibis, pdtb, rst, sdrt, toulmin (+5 more)

### Community 1612 - "PageAnchor"
Cohesion: 0.15
...
### Community 1614 - "PageAnchor"
Cohesion: 0.15
Nodes (13): PageAnchor, minimum, title, type, additionalProperties, properties, title, type (+5 more)

### Community 1615 - "mapping"
Cohesion: 0.15
...
### Community 1620 - "$defs"
Cohesion: 0.15
Nodes (13): $defs, ExactText, NonEmpty, PdtbSense, RelationId, minLength, type, minLength (+5 more)

### Community 1621 - "PdtbArgument"
Cohesion: 0.15
Nodes (13): PdtbArgument, spans, additionalProperties, description, properties, required, title, type (+5 more)

### Community 1622 - "$defs"
Cohesion: 0.15
Nodes (13): $defs, ExactText, NonEmpty, PdtbSense, RelationId, minLength, type, minLength (+5 more)

### Community 1623 - "PdtbArgument"
Cohesion: 0.15
Nodes (13): PdtbArgument, spans, additionalProperties, description, properties, required, title, type (+5 more)
...
### Community 1631 - "mapping"
Cohesion: 0.15
Nodes (13): SourceAnchor, mapping, propertyName, archive_member, coordinate_box, item, page, page_box (+5 more)

### Community 1632 - "required"
Cohesion: 0.15
Nodes (13): additionalProperties, required, title, type, AnalysisSubstrateTransformation, affected_ranges, algorithm, algorithm_version (+5 more)
...
### Community 1634 - "end"
Cohesion: 0.15
Nodes (13): exclusiveMinimum, title, type, end, start, text, properties, minimum (+5 more)

### Community 1635 - "end"
Cohesion: 0.15
Nodes (13): exclusiveMinimum, title, type, end, start, text, properties, minimum (+5 more)

### Community 1636 - "properties"
Cohesion: 0.17
Nodes (13): properties, type, read_versions, schema_names, write_version, items, title, type (+5 more)

### Community 1637 - "properties"
Cohesion: 0.17
Nodes (13): properties, type, read_versions, schema_names, write_version, items, title, type (+5 more)
...
### Community 1639 - "critical_questions"
Cohesion: 0.15
Nodes (13): items, title, type, items, title, type, $ref, items (+5 more)

### Community 1640 - "enum"
Cohesion: 0.15
Nodes (13): ad_hominem, analogy, cause_to_effect, consequences, example, expert_opinion, popular_opinion, position_to_know (+5 more)

### Community 1641 - "critical_questions"
Cohesion: 0.15
Nodes (13): items, title, type, items, title, type, $ref, items (+5 more)
...
### Community 1645 - "required"
Cohesion: 0.17
Nodes (12): HistoricalNativeTechniqueResult, additionalProperties, description, required, title, type, formalism_id, payload (+4 more)

### Community 1646 - "FormalismDeclaration"
Cohesion: 0.20
Nodes (12): FormalismDeclaration, additionalProperties, description, required, title, type, capability, formalism_id (+4 more)

### Community 1647 - "FormalismDeclaration"
Cohesion: 0.20
Nodes (12): FormalismDeclaration, additionalProperties, description, required, title, type, capability, formalism_id (+4 more)

### Community 1648 - "$defs"
Cohesion: 0.17
Nodes (12): $defs, DerivedFromRecord, Technique, additionalProperties, required, title, type, result_identity (+4 more)

### Community 1649 - "$defs"
Cohesion: 0.17
Nodes (12): $defs, DerivedFromRecord, Technique, additionalProperties, required, title, type, result_identity (+4 more)

### Community 1650 - "required"
Cohesion: 0.17
Nodes (12): additionalProperties, required, title, type, AnalysisExecutionEvidence, cache_status, device, duration_ms (+4 more)

### Community 1651 - "required"
Cohesion: 0.17
Nodes (12): additionalProperties, required, title, type, AnalysisExecutionEvidence, cache_status, device, duration_ms (+4 more)

### Community 1652 - "enum"
Cohesion: 0.17
Nodes (12): Relation, generalizes, is_suggested_by, objects_to, questions, replaces, responds_to, specializes (+4 more)

### Community 1653 - "enum"
Cohesion: 0.17
Nodes (12): Relation, generalizes, is_suggested_by, objects_to, questions, replaces, responds_to, specializes (+4 more)

### Community 1654 - "machine-ibis-result.serialization.schema.json"
Cohesion: 0.17
Nodes (11): additionalProperties, $id, extraction, grammar, input_origin, map, structure, required (+3 more)

### Community 1655 - "$defs"
Cohesion: 0.17
Nodes (12): $defs, IssueOutput, NodeKind, additionalProperties, title, type, argument, issue (+4 more)

### Community 1656 - "machine-ibis-result.validation.schema.json"
Cohesion: 0.17
Nodes (11): additionalProperties, $id, extraction, grammar, input_origin, map, structure, required (+3 more)
...
### Community 1658 - "contributing_item_ids"
Cohesion: 0.18
Nodes (12): items, minItems, title, type, default, items, title, type (+4 more)

### Community 1659 - "contributing_item_ids"
Cohesion: 0.18
Nodes (12): items, minItems, title, type, default, items, title, type (+4 more)

### Community 1660 - "enum"
Cohesion: 0.17
Nodes (12): enum, title, type, busy, dependency_unavailable, internal_error, interrupted, invalid_request (+4 more)

### Community 1661 - "enum"
Cohesion: 0.17
Nodes (12): enum, title, type, busy, dependency_unavailable, internal_error, interrupted, invalid_request (+4 more)

### Community 1662 - "required"
Cohesion: 0.17
Nodes (12): additionalProperties, required, title, type, AnalysisExecutionEvidence, cache_status, device, duration_ms (+4 more)

### Community 1663 - "required"
Cohesion: 0.17
Nodes (12): additionalProperties, required, title, type, AnalysisExecutionEvidence, cache_status, device, duration_ms (+4 more)

### Community 1664 - "ComplexDiscourseUnit"
Cohesion: 0.17
Nodes (12): additionalProperties, description, properties, title, type, ComplexDiscourseUnit, minItems, title (+4 more)

### Community 1665 - "ElementaryDiscourseUnit"
Cohesion: 0.17
Nodes (12): required, ElementaryDiscourseUnit, additionalProperties, description, required, title, type, end (+4 more)

### Community 1666 - "ComplexDiscourseUnit"
Cohesion: 0.17
Nodes (12): additionalProperties, description, properties, title, type, ComplexDiscourseUnit, minItems, title (+4 more)

### Community 1667 - "ElementaryDiscourseUnit"
Cohesion: 0.17
Nodes (12): required, ElementaryDiscourseUnit, additionalProperties, description, required, title, type, end (+4 more)

### Community 1668 - "machine-walton-result-v1.serialization.schema.json"
Cohesion: 0.17
Nodes (11): additionalProperties, $id, extraction, instance_count, instances, scheme_set, total_open_questions, required (+3 more)

### Community 1669 - "required"
Cohesion: 0.17
Nodes (12): HistoricalInstanceOutput, additionalProperties, required, title, type, conclusion, critical_questions, open_question_count (+4 more)

### Community 1670 - "machine-walton-result-v1.validation.schema.json"
Cohesion: 0.17
Nodes (11): additionalProperties, $id, extraction, instance_count, instances, scheme_set, total_open_questions, required (+3 more)

### Community 1671 - "required"
Cohesion: 0.17
Nodes (12): HistoricalInstanceOutput, additionalProperties, required, title, type, conclusion, critical_questions, open_question_count (+4 more)
...
Cohesion: 0.18
Nodes (11): properties, const, default, $ref, title, type, contract_version, provider_id (+3 more)

### Community 1678 - "contract_version"
Cohesion: 0.18
Nodes (11): properties, const, default, $ref, title, type, contract_version, provider_id (+3 more)

### Community 1679 - "required"
Cohesion: 0.18
Nodes (11): SourceFormCapability, accepted_media_types, availability, missing_distributions, preparation_supported, required_extra, source_form, additionalProperties (+3 more)

### Community 1680 - "max_workers"
Cohesion: 0.18
Nodes (11): anyOf, default, title, properties, default, maximum, minimum, title (+3 more)

### Community 1681 - "max_workers"
Cohesion: 0.18
Nodes (11): anyOf, default, title, properties, default, maximum, minimum, title (+3 more)

### Community 1682 - "machine-dung-result.serialization.schema.json"
Cohesion: 0.18
Nodes (10): additionalProperties, $id, algorithm, extensions, framework, input_origin, required, $schema (+2 more)

### Community 1683 - "machine-dung-result.validation.schema.json"
Cohesion: 0.18
Nodes (10): additionalProperties, $id, algorithm, extensions, framework, input_origin, required, $schema (+2 more)

### Community 1684 - "properties"
Cohesion: 0.18
Nodes (11): minLength, title, type, properties, from, relation, to, $ref (+3 more)

### Community 1685 - "properties"
Cohesion: 0.18
Nodes (11): properties, minLength, title, type, $ref, id, kind, text (+3 more)

### Community 1686 - "nodes"
Cohesion: 0.20
Nodes (11): $ref, items, title, type, items, minItems, title, type (+3 more)

### Community 1687 - "properties"
Cohesion: 0.18
Nodes (11): minLength, title, type, properties, from, relation, to, $ref (+3 more)

### Community 1688 - "properties"
Cohesion: 0.18
Nodes (11): properties, minLength, title, type, $ref, id, kind, text (+3 more)

### Community 1689 - "nodes"
Cohesion: 0.20
Nodes (11): $ref, items, title, type, items, minItems, title, type (+3 more)
...
### Community 1692 - "source_alignment"
Cohesion: 0.18
Nodes (11): $ref, source_alignment, source_anchors, default, items, title, type, items (+3 more)
...
Cohesion: 0.18
Nodes (10): additionalProperties, $id, category, message, operation, retryability, required, $schema (+2 more)

### Community 1696 - "code"
Cohesion: 0.18
Nodes (11): pattern, title, type, title, type, properties, title, type (+3 more)

### Community 1697 - "machine-operation-error.validation.schema.json"
Cohesion: 0.18
Nodes (10): additionalProperties, $id, category, message, operation, retryability, required, $schema (+2 more)
...
### Community 1699 - "machine-pdtb-result.serialization.schema.json"
Cohesion: 0.18
Nodes (10): additionalProperties, $id, extraction, relation_count, relation_type_counts, relations, required, $schema (+2 more)

### Community 1700 - "enum"
Cohesion: 0.18
Nodes (11): RelationType, AltLex, AltLexC, EntRel, Explicit, Hypophora, Implicit, NoRel (+3 more)

### Community 1701 - "machine-pdtb-result.validation.schema.json"
Cohesion: 0.18
Nodes (10): additionalProperties, $id, extraction, relation_count, relation_type_counts, relations, required, $schema (+2 more)
...
Cohesion: 0.18
Nodes (11): SdrtRelation, label, relation_id, source_id, structural_type, target_id, additionalProperties, description (+3 more)

### Community 1708 - "properties"
Cohesion: 0.18
Nodes (11): properties, exclusiveMinimum, title, type, end, start, text, minimum (+3 more)

### Community 1709 - "properties"
Cohesion: 0.18
Nodes (11): $ref, label, relation_id, source_id, structural_type, target_id, $ref, properties (+3 more)

### Community 1710 - "SdrtRelation"
Cohesion: 0.18
Nodes (11): SdrtRelation, label, relation_id, source_id, structural_type, target_id, additionalProperties, description (+3 more)

### Community 1711 - "properties"
Cohesion: 0.18
Nodes (11): properties, exclusiveMinimum, title, type, end, start, text, minimum (+3 more)

### Community 1712 - "properties"
Cohesion: 0.18
Nodes (11): $ref, label, relation_id, source_id, structural_type, target_id, $ref, properties (+3 more)

### Community 1713 - "machine-toulmin-result.serialization.schema.json"
Cohesion: 0.18
Nodes (10): additionalProperties, $id, extraction, layout_count, layouts, qualified_layout_count, required, $schema (+2 more)

### Community 1714 - "machine-toulmin-result-v1.serialization.schema.json"
Cohesion: 0.18
Nodes (10): additionalProperties, $id, extraction, fully_qualified_count, layout_count, layouts, required, $schema (+2 more)

### Community 1715 - "required"
Cohesion: 0.25
Nodes (11): required, enum, backing, claim, elements_present, grounds, is_qualified, qualifier (+3 more)

### Community 1716 - "machine-toulmin-result-v1.validation.schema.json"
Cohesion: 0.18
Nodes (10): additionalProperties, $id, extraction, fully_qualified_count, layout_count, layouts, required, $schema (+2 more)

### Community 1717 - "required"
Cohesion: 0.25
Nodes (11): required, enum, backing, claim, elements_present, grounds, is_qualified, qualifier (+3 more)

### Community 1718 - "machine-toulmin-result.validation.schema.json"
Cohesion: 0.18
Nodes (10): additionalProperties, $id, extraction, layout_count, layouts, qualified_layout_count, required, $schema (+2 more)

### Community 1719 - "required"
Cohesion: 0.18
Nodes (11): additionalProperties, description, required, title, type, AggregateAnalysis, configurations, outcomes (+3 more)

### Community 1720 - "enum"
Cohesion: 0.18
Nodes (11): DispositionReason, enum, title, type, authored_primary, exact_conversion_duplicate, invalid_source_item, machine_generated_primary (+3 more)

### Community 1721 - "required"
Cohesion: 0.18
Nodes (11): additionalProperties, description, required, title, type, AggregateAnalysis, configurations, outcomes (+3 more)
...
### Community 1723 - "required"
Cohesion: 0.18
Nodes (11): QuestionOutput, evidence, index, note, question, reason, status, additionalProperties (+3 more)

### Community 1724 - "required"
Cohesion: 0.18
Nodes (11): QuestionOutput, evidence, index, note, question, reason, status, additionalProperties (+3 more)

### Community 1725 - "contributing_item_ids"
Cohesion: 0.20
Nodes (10): items, minItems, title, type, HistoricalResultSourceAlignment, additionalProperties, description, properties (+2 more)

### Community 1726 - "enum"
Cohesion: 0.20
Nodes (10): SourceForm, doclang_archive, doclang_xml, docling_json, edus, markdown, text, enum (+2 more)

### Community 1727 - "formalisms"
Cohesion: 0.20
Nodes (10): default, items, title, type, $ref, formalisms, techniques, items (+2 more)

### Community 1728 - "formalisms"
Cohesion: 0.20
Nodes (10): default, items, title, type, $ref, formalisms, techniques, items (+2 more)
...
### Community 1733 - "machine-ibis-input.validation.schema.json"
Cohesion: 0.20
Nodes (9): additionalProperties, description, $id, links, nodes, required, $schema, title (+1 more)

### Community 1734 - "HistoricalResultSourceAlignment"
Cohesion: 0.20
Nodes (10): HistoricalResultSourceAlignment, additionalProperties, description, required, title, type, contributing_item_ids, payload_path (+2 more)

### Community 1735 - "HistoricalResultSourceAlignment"
Cohesion: 0.20
Nodes (10): HistoricalResultSourceAlignment, additionalProperties, description, required, title, type, contributing_item_ids, payload_path (+2 more)

### Community 1736 - "algorithm"
Cohesion: 0.20
Nodes (10): const, default, title, type, pattern, title, type, algorithm (+2 more)

### Community 1737 - "algorithm"
Cohesion: 0.20
Nodes (10): const, default, title, type, pattern, title, type, algorithm (+2 more)

### Community 1738 - "PdtbRelation"
Cohesion: 0.20
Nodes (10): PdtbRelation, arg1, arg2, relation_id, relation_type, additionalProperties, description, required (+2 more)

### Community 1739 - "PdtbRelation"
Cohesion: 0.20
Nodes (10): PdtbRelation, arg1, arg2, relation_id, relation_type, additionalProperties, description, required (+2 more)

### Community 1740 - "SourceArtifactRef"
Cohesion: 0.20
Nodes (10): $ref, SourceArtifactRef, artifact, artifact, additionalProperties, description, properties, required (+2 more)

### Community 1741 - "enum"
Cohesion: 0.20
Nodes (10): SourceForm, doclang_archive, doclang_xml, docling_json, edus, markdown, text, enum (+2 more)

### Community 1742 - "SourceArtifactRef"
Cohesion: 0.20
Nodes (10): $ref, SourceArtifactRef, artifact, artifact, additionalProperties, description, properties, required (+2 more)
...
Cohesion: 0.20
Nodes (10): additionalProperties, required, title, type, $defs, ContractSupport, contract, read_versions (+2 more)

### Community 1747 - "ContractSupport"
Cohesion: 0.20
Nodes (10): additionalProperties, required, title, type, $defs, ContractSupport, contract, read_versions (+2 more)
...
### Community 1749 - "LineEndingParameters"
Cohesion: 0.20
...
Cohesion: 0.22
Nodes (9): additionalProperties, required, title, type, ContractSupport, contract, read_versions, schema_names (+1 more)

### Community 1757 - "machine-capabilities-v1.serialization.schema.json"
Cohesion: 0.22
Nodes (8): additionalProperties, description, $id, techniques, required, $schema, title, type

### Community 1758 - "properties"
Cohesion: 0.22
Nodes (9): const, default, title, type, properties, contract, semantic_digest, anyOf (+1 more)

### Community 1759 - "machine-capabilities-v1.validation.schema.json"
Cohesion: 0.22
Nodes (8): additionalProperties, description, $id, techniques, required, $schema, title, type

### Community 1760 - "properties"
Cohesion: 0.22
Nodes (9): const, default, title, type, properties, contract, semantic_digest, anyOf (+1 more)

### Community 1761 - "ExtensionOutput"
Cohesion: 0.22
Nodes (9): ExtensionOutput, additionalProperties, required, title, type, complete, grounded, preferred (+1 more)

### Community 1762 - "enum"
Cohesion: 0.22
Nodes (9): dung, erst, ibis, pdtb, rst, sdrt, toulmin, walton (+1 more)

### Community 1763 - "ExtensionOutput"
Cohesion: 0.22
Nodes (9): ExtensionOutput, additionalProperties, required, title, type, complete, grounded, preferred (+1 more)
...
### Community 1765 - "MapOutput"
Cohesion: 0.22
Nodes (9): MapOutput, isolated_nodes, issues, issues_without_positions, positions_without_arguments, additionalProperties, required, title (+1 more)

### Community 1766 - "MapOutput"
Cohesion: 0.22
Nodes (9): MapOutput, isolated_nodes, issues, issues_without_positions, positions_without_arguments, additionalProperties, required, title (+1 more)

### Community 1767 - "Retryability"
Cohesion: 0.22
Nodes (9): $defs, Retryability, not_retryable, retryable, unknown, description, enum, title (+1 more)

### Community 1768 - "Retryability"
Cohesion: 0.22
Nodes (9): $defs, Retryability, not_retryable, retryable, unknown, description, enum, title (+1 more)

### Community 1769 - "ExtractionRecord"
Cohesion: 0.22
Nodes (9): ExtractionRecord, additionalProperties, required, title, type, instructions_digest, model, output_attempts (+1 more)

### Community 1770 - "ExtractionRecord"
Cohesion: 0.22
Nodes (9): ExtractionRecord, additionalProperties, required, title, type, instructions_digest, model, output_attempts (+1 more)

### Community 1771 - "SourceArtifact"
Cohesion: 0.22
Nodes (9): SourceArtifact, media_type, source_form, source_name, additionalProperties, description, required, title (+1 more)

### Community 1772 - "SourceArtifact"
Cohesion: 0.22
Nodes (9): SourceArtifact, media_type, source_form, source_name, additionalProperties, description, required, title (+1 more)
...
### Community 1777 - "ExtractionRecord"
Cohesion: 0.22
Nodes (9): ExtractionRecord, additionalProperties, required, title, type, instructions_digest, model, output_attempts (+1 more)

### Community 1778 - "ExtractionRecord"
Cohesion: 0.22
Nodes (9): ExtractionRecord, additionalProperties, required, title, type, instructions_digest, model, output_attempts (+1 more)

### Community 1779 - "SourceEvidenceSpan"
Cohesion: 0.22
Nodes (9): SourceEvidenceSpan, end, start, text, additionalProperties, description, required, title (+1 more)

### Community 1780 - "ExtractionRecord"
Cohesion: 0.22
Nodes (9): ExtractionRecord, additionalProperties, required, title, type, instructions_digest, model, output_attempts (+1 more)

### Community 1781 - "ExtractionRecord"
Cohesion: 0.22
Nodes (9): ExtractionRecord, additionalProperties, required, title, type, instructions_digest, model, output_attempts (+1 more)

### Community 1782 - "ExtractionRecord"
Cohesion: 0.22
Nodes (9): ExtractionRecord, additionalProperties, required, title, type, instructions_digest, model, output_attempts (+1 more)

### Community 1783 - "SourceEvidenceSpan"
Cohesion: 0.22
Nodes (9): SourceEvidenceSpan, end, start, text, additionalProperties, description, required, title (+1 more)

### Community 1784 - "machine-version.serialization.schema.json"
Cohesion: 0.22
Nodes (8): additionalProperties, $id, contracts, version, required, $schema, title, type

### Community 1785 - "properties"
Cohesion: 0.22
Nodes (9): const, default, title, type, properties, package, version, title (+1 more)

### Community 1786 - "machine-version.validation.schema.json"
Cohesion: 0.22
Nodes (8): additionalProperties, $id, contracts, version, required, $schema, title, type

### Community 1787 - "properties"
Cohesion: 0.22
Nodes (9): const, default, title, type, properties, package, version, title (+1 more)
...
### Community 1790 - "ExtractionRecord"
Cohesion: 0.22
Nodes (9): ExtractionRecord, additionalProperties, required, title, type, instructions_digest, model, output_attempts (+1 more)

### Community 1791 - "SourceEvidenceSpan"
Cohesion: 0.22
Nodes (9): SourceEvidenceSpan, end, start, text, additionalProperties, description, required, title (+1 more)

### Community 1792 - "ExtractionRecord"
Cohesion: 0.22
Nodes (9): ExtractionRecord, additionalProperties, required, title, type, instructions_digest, model, output_attempts (+1 more)

### Community 1793 - "ExtractionRecord"
Cohesion: 0.22
Nodes (9): ExtractionRecord, additionalProperties, required, title, type, instructions_digest, model, output_attempts (+1 more)

### Community 1794 - "ExtractionRecord"
Cohesion: 0.22
Nodes (9): ExtractionRecord, additionalProperties, required, title, type, instructions_digest, model, output_attempts (+1 more)

### Community 1795 - "SourceEvidenceSpan"
Cohesion: 0.22
Nodes (9): SourceEvidenceSpan, end, start, text, additionalProperties, description, required, title (+1 more)
...
### Community 1800 - "UnavailableReason"
Cohesion: 0.25
Nodes (8): UnavailableReason, missing_structured_input, model_unavailable, not_implemented, description, enum, title, type

### Community 1801 - "UnavailableReason"
Cohesion: 0.25
Nodes (8): UnavailableReason, missing_structured_input, model_unavailable, not_implemented, description, enum, title, type

### Community 1802 - "UnavailableReason"
Cohesion: 0.25
Nodes (8): UnavailableReason, missing_structured_input, model_unavailable, not_implemented, description, enum, title, type

### Community 1803 - "UnavailableReason"
Cohesion: 0.25
Nodes (8): UnavailableReason, missing_structured_input, model_unavailable, not_implemented, description, enum, title, type

### Community 1804 - "AlgorithmOutput"
Cohesion: 0.25
Nodes (8): additionalProperties, required, title, type, AlgorithmOutput, capacity, name, version

### Community 1805 - "DungInput"
Cohesion: 0.25
Nodes (8): DungInput, additionalProperties, description, required, title, type, arguments, attacks

### Community 1806 - "AlgorithmOutput"
Cohesion: 0.25
Nodes (8): additionalProperties, required, title, type, AlgorithmOutput, capacity, name, version

### Community 1807 - "DungInput"
Cohesion: 0.25
Nodes (8): DungInput, additionalProperties, description, required, title, type, arguments, attacks

### Community 1808 - "$defs"
Cohesion: 0.25
Nodes (8): $defs, NodeKind, argument, issue, position, enum, title, type

### Community 1809 - "IbisInputLink"
Cohesion: 0.25
Nodes (8): IbisInputLink, additionalProperties, required, title, type, from, relation, to

### Community 1810 - "IbisInputNode"
Cohesion: 0.25
Nodes (8): IbisInputNode, additionalProperties, required, title, type, id, kind, text

### Community 1811 - "$defs"
Cohesion: 0.25
Nodes (8): $defs, NodeKind, argument, issue, position, enum, title, type

### Community 1812 - "IbisInputLink"
Cohesion: 0.25
Nodes (8): IbisInputLink, additionalProperties, required, title, type, from, relation, to

### Community 1813 - "IbisInputNode"
Cohesion: 0.25
Nodes (8): IbisInputNode, additionalProperties, required, title, type, id, kind, text

### Community 1814 - "IbisInput"
Cohesion: 0.25
Nodes (8): IbisInput, additionalProperties, description, required, title, type, links, nodes

### Community 1815 - "IbisInput"
Cohesion: 0.25
Nodes (8): IbisInput, additionalProperties, description, required, title, type, links, nodes

### Community 1816 - "InputIssue"
Cohesion: 0.25
Nodes (8): InputIssue, additionalProperties, required, title, type, code, expected, path

### Community 1817 - "InputIssue"
Cohesion: 0.25
Nodes (8): InputIssue, additionalProperties, required, title, type, code, expected, path

### Community 1818 - "machine-preparation-request.serialization.schema.json"
Cohesion: 0.25
Nodes (7): additionalProperties, $id, source, required, $schema, title, type

### Community 1819 - "machine-preparation-request.validation.schema.json"
Cohesion: 0.25
Nodes (7): additionalProperties, $id, source, required, $schema, title, type
...
### Community 1824 - "conversion_provenance"
Cohesion: 0.25
Nodes (8): default, items, title, type, $ref, conversion_provenance, items, items
...
### Community 1826 - "$defs"
Cohesion: 0.25
Nodes (8): $defs, LayoutOutput, NonEmpty, additionalProperties, title, type, minLength, type

### Community 1827 - "HistoricalLayoutOutput"
Cohesion: 0.25
Nodes (8): $defs, HistoricalLayoutOutput, NonEmpty, additionalProperties, title, type, minLength, type

### Community 1828 - "HistoricalLayoutOutput"
Cohesion: 0.25
Nodes (8): $defs, HistoricalLayoutOutput, NonEmpty, additionalProperties, title, type, minLength, type
...
### Community 1830 - "CriticalQuestionStatus"
Cohesion: 0.25
Nodes (8): description, enum, title, type, CriticalQuestionStatus, addressed, not_assessable, open

### Community 1831 - "$defs"
Cohesion: 0.25
Nodes (8): $defs, NonEmpty, SchemeId, minLength, type, description, title, type
...
### Community 1836 - "enum"
Cohesion: 0.25
Nodes (8): encoder_config, model_card, parser_state, tokenizer, relation_inventory, role, enum, type
...
### Community 1844 - "default_formalism"
Cohesion: 0.29
Nodes (7): default, enum, title, type, erst_graph, rst_tree, default_formalism

### Community 1845 - "evidence_detail"
Cohesion: 0.29
Nodes (7): default, enum, title, type, decision_complete, normalized_distributions, evidence_detail

### Community 1846 - "marker_refinement"
Cohesion: 0.29
Nodes (7): disabled, evidence_preserving, default, enum, title, type, marker_refinement

### Community 1847 - "default_formalism"
Cohesion: 0.29
Nodes (7): default, enum, title, type, erst_graph, rst_tree, default_formalism
...
### Community 1849 - "marker_refinement"
Cohesion: 0.29
Nodes (7): disabled, evidence_preserving, default, enum, title, type, marker_refinement

### Community 1850 - "result_identity"
Cohesion: 0.29
Nodes (7): properties, result_identity, technique, pattern, title, type, $ref

### Community 1851 - "result_identity"
Cohesion: 0.29
Nodes (7): properties, result_identity, technique, pattern, title, type, $ref
...
### Community 1853 - "Sha256Identity"
Cohesion: 0.29
Nodes (7): Sha256Identity, hex_digest, additionalProperties, description, required, title, type

### Community 1854 - "Sha256Identity"
Cohesion: 0.29
Nodes (7): Sha256Identity, hex_digest, additionalProperties, description, required, title, type

### Community 1855 - "ConversionActivity"
Cohesion: 0.29
Nodes (7): additionalProperties, required, title, type, ConversionActivity, activity_id, tool

### Community 1856 - "SourceIdentity"
Cohesion: 0.29
...
### Community 1869 - "JsonValue"
Cohesion: 0.19
Nodes (3): JsonValue, Which of the six elements this layout actually carries, in Toulmin's order., A qualified layout states the force of its claim or the conditions that defeat…

### Community 1870 - "raw_size_bytes"
Cohesion: 0.40
Nodes (5): raw_size_bytes, default, minimum, title, type

### Community 1871 - "elements_present"
Cohesion: 0.40
Nodes (5): items, title, type, type, elements_present

### Community 1872 - "elements_present"
Cohesion: 0.40
Nodes (5): items, title, type, type, elements_present

### Community 1873 - "elements_present"
Cohesion: 0.40
Nodes (5): items, title, type, type, elements_present

### Community 1874 - "elements_present"
Cohesion: 0.40
Nodes (5): items, title, type, type, elements_present

### Community 1875 - "contract"
Cohesion: 0.40
Nodes (5): const, default, title, type, contract

### Community 1876 - "contract_version"
Cohesion: 0.40
Nodes (5): const, default, title, type, contract_version

### Community 1877 - "contracts"
Cohesion: 0.40
Nodes (5): items, title, type, $ref, contracts

### Community 1878 - "contract"
Cohesion: 0.40
Nodes (5): const, default, title, type, contract

### Community 1879 - "contract_version"
Cohesion: 0.40
Nodes (5): const, default, title, type, contract_version

### Community 1880 - "contracts"
Cohesion: 0.40
Nodes (5): items, title, type, $ref, contracts

### Community 1881 - "premises"
Cohesion: 0.40
Nodes (5): $ref, additionalProperties, title, type, premises

### Community 1882 - "premises"
Cohesion: 0.40
Nodes (5): $ref, additionalProperties, title, type, premises

### Community 1883 - "test_model_promotion.py"
Cohesion: 0.14
Nodes (24): canonical_json_bytes(), compatibility_redeclaration_path(), CompatibilityRedeclaration, field_validator, PurePosixPath, An explicit, evidence-backed re-declaration of a release's package…, Where a release's compatibility re-declaration lives: beside, never inside, the…, _candidate() (+16 more)
...
### Community 1889 - ".a_layout_is_not_a_premise_conclusion_pair"
Cohesion: 0.50
...
## Knowledge Gaps
- **13180 isolated node(s):** `no-assumptions-check.sh script`, `cleanup.sh script`, `rdam`, `additionalProperties`, `title` (+13175 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 15691 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
...
- **Why does `ComponentIdentity` connect `parser_result.py` to `$defs`, `mapping`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `component_digest_for()` connect `parser_result.py` to `Sha256Identity`?**
