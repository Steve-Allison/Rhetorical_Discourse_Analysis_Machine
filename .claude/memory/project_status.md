...
- Inherited research modules (`*/src/parser/`, `*/src/corpus/`, `multiple_runs.py`, `data_manager.py`, `du_converter.py`, `rstviewer/`) are touched surgically. New modules use modern Python 3.13+ idioms. See [[code-standards-modes]].
