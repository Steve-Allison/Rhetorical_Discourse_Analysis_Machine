...
def describe_capabilities(
    ...
    semantic = capabilities.semantic.model_copy(
        update={
            ...
            "evidence_detail_levels": (tuple(EvidenceDetailPolicy) if canonical else ()),
            "cache_eligibility": CacheEligibility(
                state=(CacheEligibilityState.ELIGIBLE if immutable and canonical else CacheEligibilityState.INELIGIBLE),
                reason=(
