...
directly inside :mod:`rdam.rst`.  Additionally, it provides utilities for
...
def render(
    ...
    *,
    ...
    This is a light-weight proxy around :func:`rdam.rst.rstviewer.main.render`.
    """
...
def to_html(
    ...
    *,
    ...
    user, project:
        Passed through to :func:`rdam.rst.rstviewer.main.rs3tohtml` to maintain
...
def _run_coro_sync_result[T](coro: Awaitable[T]) -> T:
    ...
    with ThreadPoolExecutor(max_workers=1, thread_name_prefix="rdam-rst-async") as executor:
